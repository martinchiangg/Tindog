 ...
 */ var A = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new k(T.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new k(T.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new k(T.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new k(T.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.$ = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new k(T.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(P), R = /^[_a-zA-Z][_a-zA-Z0-9]*$/, V = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.V = function(t, e, r) {
    ...
    n.M = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new k(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new k(T.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new k(T.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new k(T.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
    ...
    if (null === e.G) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.N() + t.op.toString() + Pt(t.value);
            }(t);
...
function Jt(t, e) {
    ...
    new S((d((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
 ...
 */ function he(t, e, n) {
    return t instanceof pe ? function(t, e) {
        ...
        return Ut(n) && Ut(t.Me) ? Bt(r) : zt(t.serializer, r);
    }(t, e);
}
 ...
 */ function le(t, e) {
    return t instanceof me ? Ut(n = e) || function(t) {
 ...
 */ function ke(t, e, n) {
    return t instanceof Re ? function(t, e, n) {
 ...
 */ function De(t, e, n, r) {
    ...
    }(t, e) : t instanceof Ue ? function(t, e, n, r) {
        if (!Ae(t.Be, e)) return e;
...
function Se(t, e) {
    ...
    }(t, e instanceof ze ? e.data() : Ge.empty());
}
...
/** A mutation that deletes the document at the given key. */ var Ce = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).key = e, r.Be = n, r.type = 3 /* Delete */ , r;
    }
    return e.__extends(n, t), n;
}(Te), xe = /** @class */ function(t) {
    function n(e, n) {
        var r = this;
        return (r = t.call(this) || this).key = e, r.Be = n, r.type = 4 /* Verify */ , r;
    }
    return e.__extends(n, t), n;
}(Te), Ge = /** @class */ function() {
    function t(t) {
        this.proto = t;
    }
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.Ke = function() {
        ...
        return null != t ? new Ge(t) : this.ze;
    }, 
    /**
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new k(T.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new k(T.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ function Xe(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new bn(n)), e.nn.push(new bn(V.q(), "asc" /* ASCENDING */)); else {
 ...
 */ function Je(t) {
    var e = Ke(t, He);
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = C(e.path, e.collectionGroup, Xe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.sn = C(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.sn;
}
...
function on(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.N() + " " + e.op + " " + Pt(e.value);
...
var an = /** @class */ function(t) {
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        ...
        if (qt(r)) {
            ...
            throw new k(T.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Ct(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new k(T.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
 ...
 */ function wn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? S.P(S.U(s.referenceValue), n.key) : Dt(s, n.field(o.field)), 
 ...
 */
        ...
        return this.kn(t, new S(e)).next((function(t) {
            var e = it();
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Rn(t) {
 ...
 */ var Sn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Is = t, this.os = e, this.Rs = n, this.op = r, this.As = i, this.Ps = new Pn, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.ys && (this.clearTimeout(), this.Ps.reject(new k(T.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.Us = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Os(), this.Ss ? [ 3 /*break*/ , 2 ] : (this.Ss = !0, (n = Vn()) && "function" == typeof n.removeEventListener && n.removeEventListener("visibilitychange", this.ks), 
                    [ 4 /*yield*/ , this.Ms(t) ]);
 ...
 */
function Mn(t, e) {
    if (h("AsyncQueue", e + ": " + t), Rn(t)) return new k(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
qn.ni = -1, qn.si = 1048576, qn.ii = 41943040, qn.ti = 10, qn.ei = 1e3, qn.ri = new qn(qn.ii, qn.ti, qn.ei), 
qn.oi = new qn(qn.ni, 0, 0);
...
var Cn = /** @class */ function() {
    ...
    return t.prototype.ai = function(t, e) {
        return this.hi.add(e), Tn.resolve();
    }, t.prototype.Kn = function(t, e) {
        return Tn.resolve(this.hi.getEntries(e));
    }, t;
}(), xn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.wi = L.min(), this.Nn = t.Ti(n), this.mi = t.Ei(), this.Ii = t.Ri(), this.Ai = new kn(this.mi, this.Nn, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
    return t.prototype.yi = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.Nn, r = this.Ai, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Nn.pi(e).next((function(s) {
                            return i = s, n = o.persistence.Ti(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new kn(o.mi, n, o.persistence.Pi()), n.pi(e);
                        })).next((function(t) {
                            ...
                            // of mutation batch IDs that were affected by change.
                                                        return r.Mn(e, s).next((function(t) {
                                return {
                                    gi: t,
                                    vi: n,
                                    bi: o
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.Nn = n, this.Ai = r, this._i.Vi(this.Ai), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Nn.Oi(n, t).next((function(t) {
                return d(null !== t), r = t.keys(), e.Nn.qi(n, t);
            })).next((function() {
                return e.Nn.xi(n);
            })).next((function() {
                return e.Ai.Mn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.jt.forEach((function(i, h) {
                    ...
                    // access.
                    s.zi(i, r), a = a.nt(i, h)) : null == f || h.version.o(f.version) > 0 || 0 === h.version.o(f.version) && f.hasPendingWrites ? (s.Hi(h, r), 
                ...
                var f = n.Ii.Ui(o).next((function(t) {
    ...
    t.Gi = function(t, e, n) {
                    ...
                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Tn.forEach(t, (function(t) {
                            return Tn.forEach(t.Yn, (function(n) {
                                return f.persistence.Xi.er(e, t.targetId, n);
                            })).next((function() {
                                return Tn.forEach(t.Xn, (function(n) {
                                    return f.persistence.Xi.nr(e, t.targetId, n);
                                }));
                            }));
                        }));
                    })) ];
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Ii.hr(n, t).next((function(i) {
                ...
                r = i, Tn.resolve(r)) : e.Ii.ar(n).next((function(i) {
                    return r = new W(t, i, 0 /* Listen */ , n.ji), e.Ii.ur(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
        ...
        var n = this.di.get(e);
        return void 0 !== n ? Tn.resolve(this.fi.get(n)) : this.Ii.hr(t, e);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 5:
                    return this.fi = this.fi.remove(t), this.di.delete(r.target), [ 2 /*return*/ ];
                }
            }));
        }));
...
var Bn = /** @class */ function() {
    ...
    t.prototype.yr = function(t) {
        var e = this, n = new S(new O([])), r = new zn(n, t), i = new zn(n, t + 1), o = [];
        ...
        var e = new S(new O([])), n = new zn(e, t), r = new zn(e, t + 1), i = ut();
        return this.Ir.bt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.vr = function(t) {
        var e = new zn(t, 0), n = this.mr.Ct(e);
    ...
    return t.Er = function(t, e) {
        return S.P(t.key, e.key) || m(t.br, e.br);
    }, 
    /** Compare by ID then by key */ t.Rr = function(t, e) {
        return m(t.br, e.br) || S.P(t.key, e.key);
    }, t;
}(), Wn = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
Wn.Dr = new Wn("google-credentials-uid"), Wn.Fr = new Wn("first-party-uid");
...
var Qn = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = Wn.UNAUTHENTICATED, this.qr = !1, 
        /**
    ...
    function t(t, e) {
        this.Br = t, this.Wr = e, this.type = "FirstParty", this.user = Wn.Fr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new $n(this.Br, this.Wr));
    }, t.prototype.xr = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.zr = 0, this.Hr = null, this.stream = null, this.$s = new On(t, e)
        /**
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.ro(n) ];
    ...
    t.prototype.io = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new k(T.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ao(e);
            }));
        }));
    ...
    return e.__extends(n, t), n.prototype.uo = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? T.UNKNOWN : H(t.code);
                ...
                var c = Jt(t, a.document.name), h = $t(a.document.updateTime), f = new Ge({
                    mapValue: {
                ...
                g.document;
                var m = Jt(t, g.document), w = g.readTime ? $t(g.readTime) : L.min(), _ = new We(m, w), b = g.removedTargetIds || [];
                n = new yt([], b, _.key, _);
                ...
                var A = e.filter;
                A.targetId;
                var D = A.count || 0, P = new Q(D), O = A.targetId;
                n = new vt(O, P);
            }
            return n;
    ...
    n.prototype.do = function(t) {
        var e = {};
        e.database = te(this.serializer), e.removeTarget = t, this.no(e);
    }, n;
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "To", {
        /**
    ...
    n.prototype.start = function() {
        this.wo = !1, this.lastStreamToken = void 0, t.prototype.start.call(this);
        ...
        d(!!t.streamToken), this.lastStreamToken = t.streamToken, this.wo) {
        ...
        // The first response is always the handshake response
                return d(!t.writeResults || 0 === t.writeResults.length), this.wo = !0, 
        this.listener.Io();
    }, 
    /**
    ...
    n.prototype.Ro = function() {
        ...
        var t = {};
        t.database = te(this.serializer), this.no(t);
    }, 
    ...
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).credentials = e, i.Gr = n, i.serializer = r, i.Ao = !1, 
        i;
    }
    return e.__extends(n, t), n.prototype.Po = function() {
        if (this.Ao) throw new k(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Vo = function(t, e, n) {
        ...
        return this.Po(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === T.UNAUTHENTICATED && r.credentials.kr(), t;
        }));
    }, 
    ...
    n, r, i, o) {
        ...
        this.Go = function(t, e, n) {
            var r = y(t);
            return r.Po(), new Jn(e, r.Gr, r.credentials, r.serializer, n);
        }(this.xo, r, {
            ...
            var r = y(t);
            return r.Po(), new Zn(e, r.Gr, r.credentials, r.serializer, n);
        }(this.xo, r, {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 6:
                    if (t instanceof yt ? this.qo.Pe(t) : t instanceof vt ? this.qo.Ce(t) : this.qo.pe(t), 
                    n.isEqual(L.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.ko.Ui() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return e.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.ko.sr(t) ];

                  case 3:
                    return null === (n = e.sent()) ? (0 === this.Lo.length && this.Yo.to(), [ 3 /*break*/ , 7 ]) : (t = n.batchId, 
                    this.Eh(n), [ 3 /*break*/ , 6 ]);
    ...
    t.prototype.Eh = function(t) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                for (t = 0, n = this.Lo; t < n.length; t++) r = n[t], this.Yo.mo(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = this.Lo.shift(), i = An.from(r, t, n), [ 4 /*yield*/ , this.wh((function() {
                        return o.lh.Ph(i);
                    })) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return K(r = t.code) && r !== T.ABORTED ? (n = this.Lo.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.Yo.Zr(), [ 4 /*yield*/ , this.wh((function() {
                        return i.lh.yh(n.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
    ...
    function t() {
        this.Ch = new rr, this.Dh = {}, this.po = null, this.Zn = null;
    }
    return t.prototype.Fh = function(t) {
        ...
        return this.Ch = new rr, Promise.resolve();
...
n) {
    ...
    r, i, o) {
        ...
        /**
             ...
             */
        this.wa = new Map, this.Ta = new Bn, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ma = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Ea = new Map, this.Ia = Gn.li(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return [ 4 /*yield*/ , this.ko.or(Je(t)) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new ur(t, i.dr), s = o.zh(i.documents), u = dt.zt(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Jh(s, 
                    /* updateLimboDocuments= */ this.Aa, u), this.ya(n, a.ea), c = new ar(t, n, o), 
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.aa.xh(n.targetId), this.aa.Mh(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.ko.cr(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.aa.Oh(n.targetId), i.ha.ah(n.targetId), i.pa(n.targetId);
                    })).catch(Fn) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.pa(n.targetId), [ 4 /*yield*/ , this.ko.cr(n.targetId, 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.ko.Si(t) ];

                  case 2:
                    return r = e.sent(), this.aa.Fh(r.batchId), this.ga(r.batchId, n), [ 4 /*yield*/ , this.va(r.Di) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Bi(t) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", n), r = this.wa.get(t), (i = r && r.key) ? (o = (o = new $(S.P)).nt(i, new We(i, L.min())), 
                    s = ut().add(i), u = new pt(L.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new J(m), o, s), [ 4 /*yield*/ , this.Bi(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Fi(t) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Li(t) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.ko.Mi() ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Na = function(t) {
        this.Ea.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new k(T.CANCELLED, t));
            }));
        })), this.Ea.clear();
    }, t.prototype.ga = function(t, e) {
        var n = this.ma[this.currentUser.Cr()];
        n || (n = new $(m)), n = n.nt(t, e), this.ma[this.currentUser.Cr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof or ? (this.Ta.er(i.key, t), this.xa(i)) : i instanceof sr ? (c("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.Sa = function() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new cr(t)), this.da = this.da.nt(t, e), this.ha.listen(new W(Je($e(t.path)), e, 2 /* LimboResolution */ , Ln.ss));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Oa = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.ca._o(r), [ 4 /*yield*/ , this.ko.tr(i) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (c("SyncEngine", "User change. New user:", t.Cr()), 
                  ...
                  case 1:
                    ...
                    this.aa.yi(t, n.vi, n.bi), [ 4 /*yield*/ , this.va(n.gi) ];
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.Ma.get(n)) || (r = !0, i = new fr), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.na = function(t) {
        ...
        t = lt.Bt(t.query, t.docs, t.qt, t.fromCache), this.Ka = !0, this.Ga.next(t);
    }, t;
}(), dr = /** @class */ function() {
    function t() {}
    return t.prototype.Vi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.on() || n.isEqual(L.min()) ? this.tu(t, e) : this.Za.Mn(t, i).next((function(s) {
            var u = o.eu(e, s);
    ...
    return t.prototype.iu = function(t) {
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.su = this.su.add(new zn(a.key, i)), this.$n.ai(t, a.key.path.g());
        }
        return Tn.resolve(o);
        ...
        // because it precedes all other segments in an ordered traversal.
                S.W(i) || (i = i.child(""));
        var o = new zn(new S(i), 0), s = new J(m);
    ...
    t.prototype.zi = function(t) {
        ...
        for (var r = it(), i = new S(e.path.child("")), o = this.docs.ut(i)
...
var gr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.yu = new Bn, this.targetCount = 0, this.pu = Gn.ci();
    }
    return t.prototype.ge = function(t, e) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.pu = new Gn(e), this.highestTargetId = e), t.sequenceNumber > this.Vu && (this.Vu = t.sequenceNumber);
        ...
        return this.yu.Ar(e, n), Tn.resolve();
        ...
        return this.yu.yr(e), Tn.resolve();
    }, t.prototype._r = function(t, e) {
        var n = this.yu.gr(e);
        return Tn.resolve(n);
    }, t.prototype.vr = function(t, e) {
        return Tn.resolve(this.yu.vr(e));
    }, t;
}(), mr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Fu = {}, this.Nu = new Ln(0), this.$u = !1, this.$u = !0, this.Xi = t(this), 
        this.Ii = new gr(this), this.$n = new Cn, this.Fn = new vr(this.$n, (function(t) {
            return e.Xi.ku(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Fu[t.Cr()];
        return e || (e = new yr(this.$n, this.Xi), this.Fu[t.Cr()] = e), e;
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).ji = e, n;
    }
    /**
    ...
    return t.Ku = function(e) {
        ...
        return this.ju.er(n, e), this.zu.delete(n), Tn.resolve();
    }, t.prototype.nr = function(t, e, n) {
        return this.ju.nr(n, e), this.zu.add(n), Tn.resolve();
    ...
    return e.__extends(n, t), n.prototype.uc = function(t, e, n, r) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case o.ErrorCode.TIMEOUT:
                        c("Connection", 'RPC "' + t + '" timed out'), s(new k(T.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case o.ErrorCode.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new k(a, r.message));
                            } else s(new k(T.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        s(new k(T.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        return y(o.WebChannel.EventType.OPEN, (function() {
            ...
            l || (l = !0, f("Connection", "WebChannel transport errored:", t), p.nc(new k(T.UNAVAILABLE, "The operation could not be completed")));
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var kr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Dr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new dr, r = t.Pc, new jn(e, n, r);
        var e, n, r;
    }, t.prototype.Ec = function(t) {
        if (t.yc.Vc) throw new k(T.FAILED_PRECONDITION, kr);
        return new mr(_r.Ku);
        ...
        throw new k(T.FAILED_PRECONDITION, kr);
    }, t;
}(), Lr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.ko ? [ 3 /*break*/ , 3 ] : (this.ko = t.ko, this.aa = t.aa, this.xo = this.pc(n), 
                    this.ha = this.gc(n), this.lh = this.vc(n), this.bc = this.Sc(n), this.aa.po = function(t) {
                        return r.lh.na(t, 1 /* SharedClientState */);
        ...
        var e = this;
        return new nr(this.ko, this.xo, t.Is, (function(t) {
 ...
 */ function Rr(t, e) {
    if (0 !== e.length) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Yr(e.length, "argument") + ".");
}
 ...
 */ function Vr(t, e, n) {
    if (e.length !== n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires " + Yr(n, "argument") + ", but was called with " + Yr(e.length, "argument") + ".");
}
 ...
 */ function Sr(t, e, n) {
    if (e.length < n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Yr(n, "argument") + ", but was called with " + Yr(e.length, "argument") + ".");
}
 ...
 */ function Ur(t, e, n, r) {
    if (e.length < n || e.length > r) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Yr(e.length, "argument") + ".");
}
...
function Gr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = zr(r);
        throw new k(T.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function jr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new k(T.INVALID_ARGUMENT, "Invalid value " + zr(r) + " provided to function " + t + "() for its " + $r(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function Fr(t, e, n, r) {
    if (!("object" === e ? Br(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = zr(r);
        throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function Wr(t, e, n) {
    if (void 0 === n) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + $r(e) + " argument, but it was undefined.");
}
 ...
 */ function Qr(t, e, n) {
    I(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new k(T.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function Kr(t, e, n, r) {
    var i = zr(r);
    return new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + $r(n) + " argument to be a " + e + ", but it was: " + i);
}

function Hr(t, e, n) {
    if (n <= 0) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + $r(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function $r(t) {
    switch (t) {
      case 1:
        return "first";
...
/** Helper function to assert Uint8Array is available at runtime. */ function Xr() {
    if ("undefined" == typeof Uint8Array) throw new k(T.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Jr() {
    if ("undefined" == typeof atob) throw new k(T.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Zr = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new k(T.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new k(T.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Yr(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Mr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new k(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Nc = new V(t);
}, ei = /** @class */ function(t) {
    /**
...
var si = /** @class */ function(t) {
    ...
    return e.__extends(n, t), n.delete = function() {
        return Rr("FieldValue.delete", arguments), new fi(new ii("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Rr("FieldValue.serverTimestamp", arguments), new fi(new si("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Sr("FieldValue.arrayUnion", arguments, 1), new fi(new ui("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return Sr("FieldValue.arrayRemove", arguments, 1), new fi(new ai("FieldValue.arrayRemove", t));
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new k(T.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new k(T.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Wc = t, this.Qc = e;
    }
    ...
    return t.prototype.zc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new Ve(t, this.data, this.qe, e)) : n.push(new Re(t, this.data, e)), 
        this.fieldTransforms.length > 0 && n.push(new Ue(t, this.fieldTransforms)), n;
    }, t;
}(), vi = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    ...
    return t.prototype.zc = function(t, e) {
        var n = [ new Ve(t, this.data, this.qe, e) ];
        return this.fieldTransforms.length > 0 && n.push(new Ue(t, this.fieldTransforms)), 
        n;
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var mi = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Yc = function(e) {
        ...
        return Pi(t, this.settings.methodName, this.settings.el || !1, this.path, this.settings.qc);
    }, 
...
/** Parse document data from a set() call. */ function _i(t, e, n, r, i, o) {
    ...
    ki("Data must be an object, but it was:", s, r);
    var u, a, c = Ai(r, s);
    if (o.merge) u = new be(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(y)) throw new k(T.INVALID_ARGUMENT, "Field '" + y + "' is specified in your field mask but missing from your input data.");
            Oi(h, y) || h.push(y);
        }
...
/** Parse update data from a list of field/value arguments. */ function Ei(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new k(T.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) u.push(Di(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new je, l = u.length - 1; l >= 0; --l) if (!Oi(h, u[l])) {
 ...
 */ function Ni(t, e) {
    if (Ti(t)) return ki("Unsupported field value:", e, t), Ai(t, e);
    if (t instanceof ri) 
 ...
 */ function Di(t, e, n) {
    ...
    throw Pi("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Li(t, n, r) {
    try {
        return function(t) {
            if (t.search(ni) >= 0) throw new k(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (ei.bind.apply(ei, e.__spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new k(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(n).Nc;
    } catch (n) {
        throw Pi((i = n) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
    /**
...
function Pi(t, e, n, r, i) {
    ...
    a += ")"), new k(T.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var Ri = /** @class */ function() {
    ...
    return t.prototype.hl = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.al(), this.mutations.length > 0) throw new k(T.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , r.yo("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = e.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Jt(t, e.found.name), r = $t(e.found.updateTime), i = new Ge({
                                                    mapValue: {
                                                ...
                                                var n = Jt(t, e.missing), r = $t(e.readTime);
                                                return new We(n, r);
                                            }(t, e) : p();
                                        }(r.serializer, t);
        ...
        this.write([ new Ce(t, this.Be(t)) ]), this.ol.add(t);
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var r = new S(O.$(e));
                        n.mutations.push(new xe(r, n.Be(r)));
        ...
        if (n) {
            ...
            throw new k(T.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.cl = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new k(T.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        this.Is = t, this.xo = e, this.updateFunction = n, this.Ps = r, this.ll = 5, this.$s = new On(this.Is, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.$s.ds((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = new Ri(this.xo), (n = this.fl(t)) && n.then((function(e) {
                        r.Is.gs((function() {
        ...
        try {
            ...
            return !U(e) && e.catch && e.then ? e : (this.Ps.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.xr((function(t) {
            if (!s) return s = !0, c("FirestoreClient", "Initializing. user=", t.uid), i.El(e, n, r, t, o).then(i.Tl.resolve, i.Tl.reject);
            i.Is.Bs((function() {
                return i.ha.ph(t);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.El = function(t, n, r, i, o) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var s, u, a = this;
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  ...
                  case 2:
                    ...
                    this.Ic = t.Ic, this.xo = n.xo, this.ha = n.ha, this.lh = n.lh, this.Il = n.bc, 
    ...
    t.prototype.ml = function() {
        if (this.Is.xs) throw new k(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                    ...
                    return [ 2 /*return*/ , (n.sent(), function(t, n, r) {
                        return e.__awaiter(this, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(s) {
                                switch (s.label) {
                                  case 0:
                                    return i = new Pn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return e.__awaiter(o, void 0, void 0, (function() {
                                            var t, o, s;
                                            return e.__generator(this, (function(e) {
                                                switch (e.label) {
                                                  case 0:
                                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , n.rr(r) ];

                                                  case 1:
                                                    return (t = e.sent()) instanceof ze ? i.resolve(t) : t instanceof We ? i.resolve(null) : i.reject(new k(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                ...
                switch (e.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Pn, o = Ui(t, e, $e(n.path), {
                                    ...
                                    return i = new Pn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return e.__awaiter(o, void 0, void 0, (function() {
                                            ...
                                            return e.__generator(this, (function(e) {
                                                switch (e.label) {
                                                  case 0:
                                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , n.lr(r, 
                                                    /* usePreviousResults= */ !0) ];

                                                  case 1:
                                                    return t = e.sent(), o = new ur(r, t.dr), s = o.zh(t.documents), u = o.Jh(s, 
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Pn, o = Ui(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new k(T.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Pn;
        return this.Is.gs((function() {
            return new Vi(e.Is, e.xo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Mi = /** @class */ function() {
    ...
    return t.prototype.bl = function(t) {
        ...
        return new li(Rt(t.latitude), Rt(t.longitude));
        ...
        var e = O.$(t);
        d(ae(e));
        var n = new b(e.get(1), e.get(3)), r = new S(e.p(5));
...
}(), qi = qn.ni, Ci = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new k(T.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Cr("settings", "non-empty string", "host", t.host), this.host = t.host, xr("settings", "boolean", "ssl", t.ssl), 
        ...
        xr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = qn.ii; else {
            if (t.cacheSizeBytes !== qi && t.cacheSizeBytes < qn.si) throw new k(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + qn.si);
    ...
    function t(n, r, i, o) {
        var s = this;
        if (void 0 === i && (i = new Dr), void 0 === o && (o = new Lr), this.kl = i, this.xl = o, 
        this.Ll = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Ol = new Un, this.INTERNAL = {
            delete: function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
            ...
            var u = n;
            this.Ll = u, this.jc = t.Ul(u), this.Bl = u.name, this.Wl = new Hn(r);
        } else {
            var a = n;
            if (!a.projectId) throw new k(T.INVALID_ARGUMENT, "Must provide projectId");
            this.jc = new b(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Bl = "[DEFAULT]", this.Wl = new Kn;
        }
        this.Ql = new Ci({});
    }
    return Object.defineProperty(t.prototype, "jl", {
        get: function() {
            ...
            this.Gl = new wi(this.jc, this.Ql.ignoreUndefinedProperties)), this.Gl;
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = new Ci(t);
        if (this.Ml && !this.Ql.isEqual(e)) throw new k(T.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.Ql = e, void 0 !== e.credentials && (this.Wl = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new k(T.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
        ...
        var e, n;
        if (this.Ml) throw new k(T.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new k(T.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var t, n = this;
            return e.__generator(this, (function(r) {
                if (void 0 !== this.Ml && !this.Ml.pl) throw new k(T.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Pn, [ 2 /*return*/ , (this.Ol.Ls((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.kl.clearPersistence(this.jc, this.Bl) ];
        ...
        if (this.ql(), Pr(t)) return this.Ml.Qa(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.zl(new Dr, new Lr, {
            Vc: !1
        }), this.Ml;
    }, t.prototype.Xl = function() {
        return new _(this.jc, this.Bl, this.Ql.host, this.Ql.ssl, this.Ql.forceLongPolling);
    }, t.prototype.zl = function(t, e, n) {
        var r = this.Xl();
        return this.Ml = new Si(this.Wl, this.Ol), this.Ml.start(r, t, e, n);
    }, t.Ul = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new k(T.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new k(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new b(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ll) throw new k(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ll;
        },
        enumerable: !1,
        configurable: !0
        ...
        this.ql(), Fi.Jl(O.$(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (Vr("Firestore.collectionGroup", arguments, 1), Mr("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new k(T.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        ...
        var e;
        Vr("Firestore.setLogLevel", arguments, 1), jr("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, u.setLogLevel(e);
    }, 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = io("Transaction.get", t, this.t_);
        return this.e_.hl([ n.Gc ]).then((function(t) {
            if (!t || 1 !== t.length) return p();
            var r = t[0];
            if (r instanceof We) return new zi(e.t_, n.Gc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            if (r instanceof ze) return new zi(e.t_, n.Gc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            throw p();
        }));
        ...
        var r = io("Transaction.set", t, this.t_);
        n = eo("Transaction.set", n);
        var i = so(r.Kc, e, n), o = _i(this.t_.jl, "Transaction.set", r.Gc, i, null !== r.Kc, n);
        return this.e_.set(r.Gc, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof ei ? (Sr("Transaction.update", arguments, 3), 
        r = io("Transaction.update", t, this.t_), i = Ei(this.t_.jl, "Transaction.update", r.Gc, e, n, o)) : (Vr("Transaction.update", arguments, 2), 
        r = io("Transaction.update", t, this.t_), i = bi(this.t_.jl, "Transaction.update", r.Gc, e)), 
        this.e_.update(r.Gc, i), this;
    }, t.prototype.delete = function(t) {
        Vr("Transaction.delete", arguments, 1);
        var e = io("Transaction.delete", t, this.t_);
    ...
    return t.prototype.set = function(t, e, n) {
        Ur("WriteBatch.set", arguments, 2, 3), this.i_();
        var r = io("WriteBatch.set", t, this.t_);
        n = eo("WriteBatch.set", n);
        var i = so(r.Kc, e, n), o = _i(this.t_.jl, "WriteBatch.set", r.Gc, i, null !== r.Kc, n);
        return this.n_ = this.n_.concat(o.zc(r.Gc, Ne.je())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.i_(), "string" == typeof e || e instanceof ei ? (Sr("WriteBatch.update", arguments, 3), 
        r = io("WriteBatch.update", t, this.t_), i = Ei(this.t_.jl, "WriteBatch.update", r.Gc, e, n, o)) : (Vr("WriteBatch.update", arguments, 2), 
        r = io("WriteBatch.update", t, this.t_), i = bi(this.t_.jl, "WriteBatch.update", r.Gc, e)), 
        this.n_ = this.n_.concat(i.zc(r.Gc, Ne.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        Vr("WriteBatch.delete", arguments, 1), this.i_();
        var e = io("WriteBatch.delete", t, this.t_);
        return this.n_ = this.n_.concat(new Ce(e.Gc, Ne.je())), this;
    }, t.prototype.commit = function() {
        return this.i_(), this.s_ = !0, this.n_.length > 0 ? this.t_.ql().write(this.n_) : Promise.resolve();
    }, t.prototype.i_ = function() {
        if (this.s_) throw new k(T.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Fi = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
    ...
    return e.__extends(n, t), n.Jl = function(t, e, r) {
        if (t.length % 2 != 0) throw new k(T.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.N() + " has " + t.length);
        ...
        !t) throw new k(T.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = O.$(t);
        ...
        Ur("DocumentReference.set", arguments, 1, 2), e = eo("DocumentReference.set", e);
        var n = so(this.Kc, t, e), r = _i(this.firestore.jl, "DocumentReference.set", this.Gc, n, null !== this.Kc, e);
        return this.Ml.write(r.zc(this.Gc, Ne.je()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof ei ? (Sr("DocumentReference.update", arguments, 2), 
        n = Ei(this.firestore.jl, "DocumentReference.update", this.Gc, t, e, r)) : (Vr("DocumentReference.update", arguments, 1), 
        n = bi(this.firestore.jl, "DocumentReference.update", this.Gc, t)), this.Ml.write(n.zc(this.Gc, Ne.exists(!0)));
    }, n.prototype.delete = function() {
        return Vr("DocumentReference.delete", arguments, 0), this.Ml.write([ new Ce(this.Gc, Ne.je()) ]);
        ...
        "object" != typeof i[u] || Pr(i[u]) || (Qr("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else Mr("DocumentReference.onSnapshot", "function", u, i[u]), qr("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        ...
        return this.Ml.listen($e(this.Gc.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        Ur("DocumentReference.get", arguments, 0, 1), ro("DocumentReference.get", t);
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (Ur("DocumentSnapshot.data", arguments, 0, 1), t = no("DocumentSnapshot.data", t), 
        this.o_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Kc) {
                var n = new Wi(this.t_, this.Gc, this.o_, this.h_, this.a_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(n, t);
            }
            return new Mi(this.t_.jc, this.t_.Zl(), t.serverTimestamps || "none", (function(t) {
                return new Fi(t, e.t_, /* converter= */ null);
            })).bl(this.o_.Ze());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (Ur("DocumentSnapshot.get", arguments, 1, 2), e = no("DocumentSnapshot.get", e), 
        this.o_) {
            var r = this.o_.data().field(Di("DocumentSnapshot.get", t, this.Gc));
            if (null !== r) return new Mi(this.t_.jc, this.t_.Zl(), e.serverTimestamps || "none", (function(t) {
                return new Fi(t, n.t_, n.Kc);
            })).bl(r);
        }
        ...
        get: function() {
            return new Fi(this.Gc, this.t_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
...
function Qi(t, e, n, r, i, o, s) {
    var u;
    if (i.O()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new k(T.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || $i(s, o), 
    u = Ii(n, e, s, 
    ...
    return function(t, e) {
        if (e.ln()) {
            var n = t.cn();
            if (null !== n && !n.isEqual(e.field)) throw new k(T.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
            var r = t.un();
 ...
 */
        ...
        throw i === e.op ? new k(T.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new k(T.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
    }(t, l), l;
}

function Ki(t, e, n) {
    if (null !== t.startAt) throw new k(T.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new k(T.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new bn(e, n);
    return function(t, e) {
        if (null === t.un()) {
...
function Hi(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!Ye(e) && -1 !== n.indexOf("/")) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(O.$(n));
        if (!S.W(r)) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return St(t, new S(r));
    }
    if (n instanceof di) return St(t, n.Gc);
    throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + zr(n) + ".");
}
 ...
 * array requirements.
 */ function $i(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new k(T.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new k(T.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if ("in" /* IN */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) {
        if (t.indexOf(null) >= 0) throw new k(T.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new k(T.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }
}

function Yi(t, e, n) {
    if (!n.isEqual(e)) throw new k(T.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function Xi(t) {
    if (t.an() && 0 === t.tn.length) throw new k(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Ji = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i;
        Vr("Query.where", arguments, 3), Wr("Query.where", 3, r), i = "not-in" === n || "!=" === n ? n : jr("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n);
        var o = Di("Query.where", e), s = Qi(this.u_, "Query.where", this.firestore.jl, this.firestore.jc, o, i, r);
        ...
        var r;
        if (Ur("Query.orderBy", arguments, 1, 2), qr("Query.orderBy", "non-empty string", 2, n), 
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new k(T.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = Di("Query.orderBy", e), o = Ki(this.u_, i, r);
        return new t(function(t, e) {
        ...
        return Vr("Query.limit", arguments, 1), Mr("Query.limit", "number", 1, e), Hr("Query.limit", 1, e), 
        new t(Ze(this.u_, e, "F" /* First */), this.firestore, this.Kc);
    }, t.prototype.limitToLast = function(e) {
        return Vr("Query.limitToLast", arguments, 1), Mr("Query.limitToLast", "number", 1, e), 
        Hr("Query.limitToLast", 1, e), new t(Ze(this.u_, e, "L" /* Last */), this.firestore, this.Kc);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Sr("Query.startAt", arguments, 1);
        var i = this.c_("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(tn(this.u_, i), this.firestore, this.Kc);
        ...
        /*before=*/ !0);
        return new t(en(this.u_, i), this.firestore, this.Kc);
        ...
        return this.firestore === e.firestore && nn(this.u_, e.u_) && this.Kc === e.Kc;
    }, t.prototype.withConverter = function(e) {
        return new t(this.u_, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.c_ = function(t, n, r, i) {
        if (Wr(t, 1, n), n instanceof zi) return Vr(t, e.__spreadArrays([ n ], r), 1), function(t, e, n, r, i) {
            if (!r) throw new k(T.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = Xe(t); s < u.length; s++) {
                ...
                if (a.field.O()) o.push(St(e, r.key)); else {
                    ...
                    if (Et(c)) throw new k(T.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
                        throw new k(T.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
            return new gn(o, i);
        }(this.u_, this.firestore.jc, t, n.o_, i);
        var o = [ n ].concat(r);
        return function(t, e, n, r, i, o) {
            // Use explicit order by's because it has to match the query the user made
            var s = t.tn;
            if (i.length > s.length) throw new k(T.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.O()) {
                    if ("string" != typeof c) throw new k(T.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!Ye(t) && -1 !== c.indexOf("/")) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(O.$(c));
                    if (!S.W(h)) throw new k(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new S(h);
                    u.push(St(e, f));
                } else {
                    var l = Ii(n, r, c);
        ...
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Pr(i[u]) || (Qr("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else Mr("Query.onSnapshot", "function", u, i[u]), qr("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        qr("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new Zi(r.firestore, r.u_, t, r.Kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return Xi(this.u_), this.firestore.ql().listen(this.u_, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        Ur("Query.get", arguments, 0, 1), ro("Query.get", t), Xi(this.u_);
        var n = this.firestore.ql();
        return (t && "cache" === t.source ? n.Vl(this.u_) : n.yl(this.u_, t)).then((function(t) {
            return new Zi(e.firestore, e.u_, t, e.Kc);
        }));
    }, t;
}(), Zi = /** @class */ function() {
    function t(t, e, n, r) {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Ur("QuerySnapshot.forEach", arguments, 1, 2), Mr("QuerySnapshot.forEach", "function", 1, t), 
        this.__.docs.forEach((function(r) {
            t.call(e, n.w_(r, n.metadata.fromCache, n.__.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Ji(this.l_, this.t_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Qr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), xr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.__.Ut) throw new k(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.t_ === e.t_ && nn(this.l_, e.l_) && this.__.isEqual(e.__) && this.Kc === e.Kc;
    }, t.prototype.w_ = function(t, e, n) {
        return new Wi(this.t_, t.key, t, e, n, this.Kc);
    }, t;
}(), to = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, $e(e), n, r) || this).T_ = e, e.length % 2 != 1) throw new k(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.N() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        Ur("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), Mr("CollectionReference.doc", "non-empty string", 1, t);
        var e = O.$(t);
        return Fi.Jl(this.u_.path.child(e), this.firestore, this.Kc);
...
function eo(t, e) {
    ...
    if (Qr(t, e, [ "merge", "mergeFields" ]), xr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + zr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new k(T.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + zr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof ei;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new k(T.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}

function no(t, e) {
    return void 0 === e ? {} : (Qr(t, e, [ "serverTimestamps" ]), Gr(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function ro(t, e) {
    qr(t, "object", 1, e), e && (Qr(t, e, [ "source" ]), Gr(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}

function io(t, e, n) {
    if (e instanceof di) {
        if (e.firestore !== n) throw new k(T.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
 ...
 */ function ao(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new s.Component("firestore", (function(t) {
            return function(t, e) {
                return new xi(t, e, new Dr, new Lr);
