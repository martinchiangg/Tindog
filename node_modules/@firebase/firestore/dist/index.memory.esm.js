...
import { XhrIo as p, EventType as d, ErrorCode as y, createWebChannelTransport as v, WebChannel as m } from "@firebase/webchannel-wrapper";
...
function E(t) {
    ...
    if (w.logLevel <= s.DEBUG) {
        var i = e.map(A);
        w.debug.apply(w, r([ "Firestore (7.18.0): " + t ], i));
    }
}
...
function I(t) {
    ...
    if (w.logLevel <= s.ERROR) {
        var i = e.map(A);
        w.error.apply(w, r([ "Firestore (7.18.0): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (w.logLevel <= s.WARN) {
        var i = e.map(A);
        w.warn.apply(w, r([ "Firestore (7.18.0): " + t ], i));
    }
}
...
/** Helper to compare arrays using isEqual(). */ function R(t, e, n) {
 ...
 */ var q = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new G(C.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new G(C.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new G(C.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new G(C.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.$ = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new G(C.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
    ...
    n.M = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new G(C.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new G(C.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new G(C.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new G(C.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
 ...
 */ function st(t) {
    ...
    return I("GRPC error has no .code"), C.UNKNOWN;
    switch (t) {
      case et.OK:
        return C.OK;
...
var mt = new ut(Q.P), gt = new ht(Q.P);
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.Ne = function(t) {
        ...
        return this.Ie = pt(), this.Re = Vt(), this.Ae = new ht(O), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Re.get(t);
        return e || (e = new ht(O), this.Re = this.Re.nt(t, e)), e;
    }, 
    /**
...
/** Extracts the backend's type order for the provided value. */ function qt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? St(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : T();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ct(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return R(t.arrayValue.values || [], e.arrayValue.values || [], Ct);
...
function xt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = O(zt(t.latitude), zt(e.latitude));
            return 0 !== n ? n : O(zt(t.longitude), zt(e.longitude));
...
function Fe(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || R(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof De && e instanceof De ? R(t.elements, e.elements, Ct) : t instanceof Oe && e instanceof Oe ? Ct(t.Me, e.Me) : t instanceof Te && e instanceof Te;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new G(C.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new G(C.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ function hn(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new Ln(n)), e.nn.push(new Ln(W.q(), "asc" /* ASCENDING */)); else {
...
var bn = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if ($t(r)) {
            ...
            throw new G(C.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Yt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new G(C.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
 ...
 */ function Rn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? Q.P(Q.U(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
 ...
 */ var Mn = /** @class */ function() {
    ...
    t.prototype.In = function(t) {
        ...
        return this.batchId === t.batchId && R(this.mutations, t.mutations, (function(t, e) {
            return Fe(t, e);
        })) && R(this.baseMutations, t.baseMutations, (function(t, e) {
            return Fe(t, e);
        }));
    }, t;
}(), qn = /** @class */ function() {
 ...
 */ var Qn = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.ys && (this.clearTimeout(), this.Ps.reject(new G(C.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */
function Hn(t, e) {
    if (I("AsyncQueue", e + ": " + t), zn(t)) return new G(C.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var er = /** @class */ function() {
    ...
    return t.Er = function(t, e) {
        return Q.P(t.key, e.key) || O(t.br, e.br);
    }, 
    /** Compare by ID then by key */ t.Rr = function(t, e) {
        return O(t.br, e.br) || Q.P(t.key, e.key);
    }, t;
}(), rr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
var ir = function(t, e) {
    ...
    t.prototype.io = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new G(C.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ao(e);
            }));
        }));
    ...
    return t(n, e), n.prototype.uo = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? C.UNKNOWN : st(t.code);
    ...
    return t(n, e), Object.defineProperty(n.prototype, "To", {
        /**
    ...
    return t(n, e), n.prototype.Po = function() {
        if (this.Ao) throw new G(C.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Vo = function(t, e, n) {
        ...
        return this.Po(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === C.UNAUTHENTICATED && r.credentials.kr(), t;
        }));
    }, 
    ...
    t.prototype.Eh = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== C.ABORTED ? (e = this.Lo.shift(), 
...
n) {
    ...
    r, i, o) {
        ...
        this.ca = null, this.la = new q((function(t) {
            return vn(t);
        }), yn), this._a = new Map, 
        /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", r), e = this.wa.get(t), (i = e && e.key) ? (o = (o = new ut(Q.P)).nt(i, new rn(i, j.min())), 
                    s = wt().add(i), u = new Tt(j.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ht(O), o, s), [ 4 /*yield*/ , this.Bi(u) ]) : [ 3 /*break*/ , 2 ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Na = function(t) {
        this.Ea.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new G(C.CANCELLED, t));
            }));
        })), this.Ea.clear();
    }, t.prototype.ga = function(t, e) {
        var n = this.ma[this.currentUser.Cr()];
        n || (n = new ut(O)), n = n.nt(t, e), this.ma[this.currentUser.Cr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof mr ? (this.Ta.er(i.key, t), this.xa(i)) : i instanceof gr ? (E("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.Oa = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (E("SyncEngine", "User change. New user:", t.Cr()), 
    ...
    function t(t) {
        this.lh = t, this.Ma = new q((function(t) {
            return vn(t);
    ...
    return t.prototype.Vi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.eu(e, o);
            return (e.hn() || e.an()) && i.Xh(e.en, u, r, n) ? i.tu(t, e) : (b() <= s.DEBUG && E("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), mn(e)), 
    ...
    t.prototype.Xh = function(t, e, n, r) {
        ...
        return b() <= s.DEBUG && E("IndexFreeQueryEngine", "Using full collection scan to execute query:", mn(e)), 
    ...
    return t.prototype.iu = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                Q.W(i) || (i = i.child(""));
        var o = new nr(new Q(i), 0), s = new ht(O);
...
var Pr = /** @class */ function() {
    ...
    return t(n, e), n.prototype.uc = function(t, e, n, r) {
            ...
            s.listenOnce(d.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case y.TIMEOUT:
                        E("Connection", 'RPC "' + t + '" timed out'), o(new G(C.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case y.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new G(u, r.message));
                            } else o(new G(C.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new G(C.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        return g(m.EventType.OPEN, (function() {
            ...
            d || (d = !0, N("Connection", "WebChannel transport errored:", t), y.nc(new G(C.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    void 0 === u && (u = C.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.nc(new G(u, a)), s.close();
 ...
 */ var Gr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", xr = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.yc.Vc) throw new G(C.FAILED_PRECONDITION, Gr);
        return new Or(Vr.Ku);
        ...
        throw new G(C.FAILED_PRECONDITION, Gr);
    }, t;
}(), jr = /** @class */ function() {
    function t() {}
 ...
 */ function zr(t, e) {
    if (0 !== e.length) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Wr(t, e, n) {
    if (e.length !== n) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires " + ai(n, "argument") + ", but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Qr(t, e, n) {
    if (e.length < n) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires at least " + ai(n, "argument") + ", but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Kr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + ai(e.length, "argument") + ".");
}
...
function Jr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = ni(r);
        throw new G(C.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Zr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new G(C.INVALID_ARGUMENT, "Invalid value " + ni(r) + " provided to function " + t + "() for its " + ui(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function ti(t, e, n, r) {
    if (!("object" === e ? ei(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = ni(r);
        throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ri(t, e, n) {
    if (void 0 === n) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ui(e) + " argument, but it was undefined.");
}
 ...
 */ function ii(t, e, n) {
    U(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new G(C.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function oi(t, e, n, r) {
    var i = ni(r);
    return new G(C.INVALID_ARGUMENT, "Function " + t + "() requires its " + ui(n) + " argument to be a " + e + ", but it was: " + i);
}

function si(t, e, n) {
    if (n <= 0) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires its " + ui(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function ci() {
    if ("undefined" == typeof Uint8Array) throw new G(C.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function hi() {
    if ("undefined" == typeof atob) throw new G(C.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var fi = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new G(C.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new G(C.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + ai(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Hr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new G(C.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Nc = new W(t);
}, pi = /** @class */ function(e) {
    /**
...
var gi = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new G(C.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new G(C.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Wc = t, this.Qc = e;
    }
     ...
     */
    t.prototype.T = function(t) {
        return O(this.Wc, t.Wc) || O(this.Qc, t.Qc);
    }, t;
...
/** Parse document data from a set() call. */ function Vi(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new Le(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(d)) throw new G(C.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Bi(h, d) || h.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function Si(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new G(C.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
...
function qi(t, e) {
    ...
    e.path && e.path.length > 0 && e.qe.push(e.path) : U(t, (function(t, r) {
        var i = Mi(r, e.Xc(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function Ci(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof Ai || t instanceof fi || t instanceof _i || t instanceof yi);
}
 ...
 */ function ji(t, e, n) {
    try {
        return function(t) {
            if (t.search(di) >= 0) throw new G(C.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (pi.bind.apply(pi, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new G(C.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Nc;
    } catch (e) {
...
function Fi(t, e, n, r, i) {
    ...
    a += ")"), new G(C.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var zi = /** @class */ function() {
    ...
    return t.prototype.hl = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.al(), this.mutations.length > 0) throw new G(C.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = k(t), i = le(e.serializer) + "/documents", o = {
        ...
        if (n) {
            ...
            throw new G(C.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.cl = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new G(C.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.xr((function(t) {
            if (!s) return s = !0, E("FirestoreClient", "Initializing. user=", t.uid), i.El(e, n, r, t, o).then(i.Tl.resolve, i.Tl.reject);
            i.Is.Bs((function() {
                return i.ha.ph(t);
            }));
        })), 
    ...
    t.prototype.ml = function() {
        if (this.Is.xs) throw new G(C.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                                        ...
                                        return e(s, void 0, void 0, (function() {
                                            ...
                                            return n(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return (t = n.sent()) instanceof nn ? o.resolve(t) : t instanceof rn ? o.resolve(null) : o.reject(new G(C.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Fn, o = Ki(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new G(C.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var Hi = /** @class */ function() {
    ...
    return t.prototype.bl = function(t) {
        ...
        var e = Bt(t), n = new x(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.Dl = function(t) {
        var e = B.$(t);
        _(be(e));
        var n = new L(e.get(1), e.get(3)), r = new Q(e.p(5));
    ...
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new G(C.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        Xr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = $n.ii; else {
            if (t.cacheSizeBytes !== $i && t.cacheSizeBytes < $n.si) throw new G(C.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + $n.si);
    ...
    function t(r, i, o, s) {
        ...
        this.Ol = new Kn, this.INTERNAL = {
            ...
            var c = r;
            if (!c.projectId) throw new G(C.INVALID_ARGUMENT, "Must provide projectId");
            this.jc = new L(c.projectId, c.database), 
    ...
    return Object.defineProperty(t.prototype, "jl", {
        ...
        var e = new Yi(t);
        if (this.Ml && !this.Ql.isEqual(e)) throw new G(C.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.Ql = e, void 0 !== e.credentials && (this.Wl = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new G(C.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
        ...
        var e, n;
        if (this.Ml) throw new G(C.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new G(C.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.Ml && !this.Ml.pl) throw new G(C.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        ...
        return new V(this.jc, this.Bl, this.Ql.host, this.Ql.ssl, this.Ql.forceLongPolling);
    }, t.prototype.zl = function(t, e, n) {
        var r = this.Xl();
        return this.Ml = new Qi(this.Wl, this.Ol), this.Ml.start(r, t, e, n);
    }, t.Ul = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new G(C.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new G(C.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new L(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ll) throw new G(C.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ll;
        },
        enumerable: !1,
        configurable: !0
        ...
        t.indexOf("/") >= 0) throw new G(C.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.s_) throw new G(C.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), to = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.Jl = function(t, e, r) {
        if (t.length % 2 != 0) throw new G(C.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.N() + " has " + t.length);
        ...
        !t) throw new G(C.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = B.$(t);
...
function io(t, e, n, r, i, o, s) {
    var u;
    if (i.O()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new G(C.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
    ...
    return function(t, e) {
        if (e.ln()) {
            var n = t.cn();
            if (null !== n && !n.isEqual(e.field)) throw new G(C.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
            var r = t.un();
 ...
 */
        ...
        throw i === e.op ? new G(C.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new G(C.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
    }(t, l), l;
}

function oo(t, e, n) {
    if (null !== t.startAt) throw new G(C.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new G(C.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new Ln(e, n);
    return function(t, e) {
        if (null === t.un()) {
...
function so(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!cn(e) && -1 !== n.indexOf("/")) throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(B.$(n));
        if (!Q.W(r)) throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Qt(t, new Q(r));
    }
    if (n instanceof _i) return Qt(t, n.Gc);
    throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ni(n) + ".");
}
 ...
 * array requirements.
 */ function uo(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new G(C.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new G(C.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if ("in" /* IN */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) {
        if (t.indexOf(null) >= 0) throw new G(C.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new G(C.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }
}

function ao(t, e, n) {
    if (!n.isEqual(e)) throw new G(C.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function co(t) {
    if (t.an() && 0 === t.tn.length) throw new G(C.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var ho = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new G(C.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.c_ = function(t, e, n, i) {
        if (ri(t, 1, e), e instanceof no) return Wr(t, r([ e ], n), 1), function(t, e, n, r, i) {
            if (!r) throw new G(C.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = hn(t); s < u.length; s++) {
                ...
                if (a.field.O()) o.push(Qt(e, r.key)); else {
                    ...
                    if (St(c)) throw new G(C.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
                        throw new G(C.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
        ...
        return function(t, e, n, r, i, o) {
            ...
            var s = t.tn;
            if (i.length > s.length) throw new G(C.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.O()) {
                    if ("string" != typeof c) throw new G(C.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!cn(t) && -1 !== c.indexOf("/")) throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(B.$(c));
                    if (!Q.W(h)) throw new G(C.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new Q(h);
                    u.push(Qt(e, f));
                } else {
                    var l = Ui(n, r, c);
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.__.Ut) throw new G(C.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, an(t), n, r) || this).T_ = t, t.length % 2 != 1) throw new G(C.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
...
function po(t, e) {
    ...
    if (ii(t, e, [ "merge", "mergeFields" ]), Xr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + ni(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new G(C.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + ni(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof pi;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new G(C.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function mo(t, e, n) {
    if (e instanceof _i) {
        if (e.firestore !== n) throw new G(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
