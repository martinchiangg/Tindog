 ...
 */ function fn(t) {
    ...
    if (null === e.nn) {
        ...
        t.O() || e.nn.push(new Ln(t)), e.nn.push(new Ln(U.q(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ (t)), t;
     ...
     */    Ts(t, e, n) {
        ...
        const s = Yn.Vs(this, t, e, n, t => this.Qs(t));
...
class Zn {
    ...
    static Zs(t) {
        return new Zn(t, Zn.ti, Zn.ei);
    }
}

Zn.ni = -1, Zn.si = 1048576, Zn.ii = 41943040, Zn.ti = 10, Zn.ei = 1e3, Zn.ri = new Zn(Zn.ii, Zn.ti, Zn.ei), 
Zn.oi = new Zn(Zn.ni, 0, 0);
...
class ts {
    ...
    ai(t, e) {
        return this.hi.add(e), Bn.resolve();
    }
    Kn(t, e) {
        return Bn.resolve(this.hi.getEntries(e));
    }
}
...
class ss {
    ...
    t, e, n) {
         ...
         */
        this.wi = L.min(), this.Nn = t.Ti(n), this.mi = t.Ei(), this.Ii = t.Ri(), this.Ai = new Wn(this.mi, this.Nn, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
    async yi(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new Wn(this.mi, e, this.persistence.Pi()), e.pi(s))).next(t => {
                const e = [], r = [];
    ...
    Si(t) {
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", i => this.Ai.Mn(i, n).next(n => {
            ...
            for (const e of t) {
                ...
                // exists=true
                r.push(new ze(e.key, t, sn(t.proto.mapValue), qe.exists(!0)));
            }
    ...
    Li(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.Nn.Oi(e, t).next(t => (P(null !== t), n = t.keys(), this.Nn.qi(e, t))).next(() => this.Nn.xi(e)).next(() => this.Ai.Mn(e, n));
        });
    }
    Mi() {
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Wt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    ss.Gi(o, a, t) && r.push(this.Ii.Ki(s, a));
                }
            });
            let o = ct(), h = Tt();
            ...
            return Bn.Cn(r).next(() => i.apply(s)).next(() => this.Ai.Un(s, o));
        }).then(t => (this.fi = n, t));
    }
    /**
    ...
    async tr(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => Bn.forEach(t, t => Bn.forEach(t.Yn, n => this.persistence.Xi.er(e, t.targetId, n)).next(() => Bn.forEach(t.Xn, n => this.persistence.Xi.nr(e, t.targetId, n)))));
        } catch (t) {
            if (!zn(t)) throw t;
    ...
    or(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, Bn.resolve(n)) : this.Ii.ar(e).next(s => (n = new J(t, s, 0 /* Listen */ , e.ji), 
    ...
    hr(t, e) {
        ...
        return void 0 !== n ? Bn.resolve(this.fi.get(n)) : this.Ii.hr(t, e);
    }
    async cr(t, e) {
    ...
    lr(t, e) {
        let n = L.min(), s = Tt();
        return this.persistence.runTransaction("Execute query", "readonly", i => this.hr(i, dn(t)).next(t => {
            if (t) return n = t.lastLimboFreeSnapshotVersion, this.Ii._r(i, t.targetId).next(t => {
                s = t;
            });
        }).next(() => this._i.Wn(i, t, e ? n : L.min(), e ? s : Tt())).next(t => ({
            documents: t,
            dr: s
        })));
    }
...
class rs {
    constructor() {
        ...
        this.mr = new ht(os.Er), 
        // A set of outstanding references to a document sorted by target id.
        this.Ir = new ht(os.Rr);
    }
     ...
     * removed.
     */    yr(t) {
        const e = new B(new q([])), n = new os(e, t), s = new os(e, t + 1), i = [];
    ...
    gr(t) {
        const e = new B(new q([])), n = new os(e, t), s = new os(e, t + 1);
        let i = Tt();
        return this.Ir.bt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    vr(t) {
        const e = new os(t, 0), n = this.mr.Ct(e);
...
class os {
    ...
    /** Compare by key then by ID */    static Er(t, e) {
        return B.P(t.key, e.key) || g(t.br, e.br);
    }
    /** Compare by ID then by key */    static Rr(t, e) {
        return g(t.br, e.br) || B.P(t.key, e.key);
    }
}
...
hs.Dr = new hs("google-credentials-uid"), hs.Fr = new hs("first-party-uid");
...
class cs {
    constructor(t) {
        ...
        this.currentUser = hs.UNAUTHENTICATED, this.qr = !1, 
        /**
 ...
 */ class ls {
    constructor(t, e) {
        this.Br = t, this.Wr = e, this.type = "FirstParty", this.user = hs.Fr;
    }
    get Nr() {
        const t = {
 ...
 */ class _s {
    ...
    getToken() {
        return Promise.resolve(new ls(this.Br, this.Wr));
    }
    xr(t) {
...
class fs {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.zr = 0, this.Hr = null, this.stream = null, this.$s = new Kn(t, e);
    }
    /**
     ...
     */    oo(t) {
        return e => {
            this.rs.gs(() => this.zr === t ? e() : (m("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class ds extends fs {
     ...
     */    do(t) {
        const e = {};
        e.database = ce(this.serializer), e.removeTarget = t, this.no(e);
    }
}
 ...
 */ class ws extends fs {
    ...
    onMessage(t) {
        ...
        P(!!t.streamToken), this.lastStreamToken = t.streamToken, this.wo) {
        ...
        return P(!t.writeResults || 0 === t.writeResults.length), this.wo = !0, this.listener.Io();
    }
    /**
     ...
     */    Ro() {
        ...
        const t = {};
        t.database = ce(this.serializer), this.no(t);
    }
...
class Ts extends class {} {
    ...
    Po() {
        if (this.Ao) throw new k($.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Vo(t, e, n) {
        return this.Po(), this.credentials.getToken().then(s => this.Gr.Vo(t, e, n, s)).catch(t => {
            throw t.code === $.UNAUTHENTICATED && this.credentials.kr(), t;
        });
    }
...
class Es {
    ...
    e, n, s, i) {
        ...
        this.Go = function(t, e, n) {
            const s = V(t);
            return s.Po(), new ds(e, s.Gr, s.credentials, s.serializer, n);
        }
        /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (this.xo, n, {
            ...
            const s = V(t);
            return s.Po(), new ws(e, s.Gr, s.credentials, s.serializer, n);
        }(this.xo, n, {
    ...
    async Ho(t, e) {
        ...
        try {
            ...
            await this.fh(e);
        } else if (t instanceof yt ? this.qo.Pe(t) : t instanceof pt ? this.qo.Ce(t) : this.qo.pe(t), 
        !e.isEqual(L.min())) try {
 ...
 */ class Rs {
    constructor() {
        this.Ch = new Is, this.Dh = {}, this.po = null, this.Zn = null;
    }
    Fh(t) {
        // No op.
    }
 ...
 */ class gs {
    ...
    s, i, r) {
        ...
        this.Ea = new Map, this.Ia = ns.li(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async listen(t) {
        ...
        e = s.targetId, this.aa.$h(e), n = s.view.ra(); else {
            const s = await this.ko.or(dn(t)), i = this.aa.$h(s.targetId);
     ...
     */    async Va(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new Vs(t, s.dr), r = i.zh(s.documents), o = Vt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jh(r, 
    ...
    async Th(t, e) {
        ...
        } else await this.ko.cr(t, /* keepPersistedTargetData */ !1).then(() => this.pa(t, e)).catch(is);
    }
    async Ph(t) {
    ...
    ga(t, e) {
        ...
        n || (n = new it(g)), n = n.nt(t, e), this.ma[this.currentUser.Cr()] = n;
    }
    /**
    ...
    ya(t, e) {
        for (const n of e) if (n instanceof As) this.Ta.er(n.key, t), this.xa(n); else if (n instanceof Ps) {
            m("SyncEngine", "Document no longer in limbo: " + n.key), this.Ta.nr(n.key, t);
            this.Ta.vr(n.key) || 
            // We removed the last reference for this key
            this.ka(n.key);
        } else A();
     ...
     */    Sa() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new ps(t)), this.da = this.da.nt(t, e), this.ha.listen(new J(dn(ln(t.path)), e, 2 /* LimboResolution */ , jn.ss));
        }
    }
    // Visible for testing
    La() {
    ...
    async ph(t) {
        if (!this.currentUser.isEqual(t)) {
            m("SyncEngine", "User change. New user:", t.Cr());
 ...
 */ class Cs {
    ...
    Wn(t, e, s, i) {
        ...
        return e.on() || s.isEqual(L.min()) ? this.tu(t, e) : this.Za.Mn(t, i).next(r => {
            const o = this.eu(e, r);
 ...
 */ class Ds {
    ...
    Ci(t, e, n, s) {
        ...
        for (const e of s) this.su = this.su.add(new os(e.key, i)), this.$n.ai(t, e.key.path.g());
        return Bn.resolve(r);
    }
    Oi(t, e) {
 ...
 */ Fs.du = class extends class {
    constructor() {
        ...
        this.Di = new N(t => t.toString(), (t, e) => t.isEqual(e)), this.Tu = !1;
    }
    set readTime(t) {
        this.mu = t;
    }
...
class Ns {
    constructor(t) {
         ...
         * IDs.
         */
        this.yu = new rs, this.targetCount = 0, this.pu = ns.ci();
    }
    ge(t, e) {
    ...
    Qi(t, e, n) {
        return this.yu.Ar(e, n), Bn.resolve();
    }
    Wi(t, e, n) {
        this.yu.Vr(e, n);
    ...
    Cu(t, e) {
        return this.yu.yr(e), Bn.resolve();
    }
    _r(t, e) {
    ...
    vr(t, e) {
        return Bn.resolve(this.yu.vr(e));
    }
}
...
class $s {
    ...
    constructor(t) {
        ...
        this.Ii = new Ns(this);
        this.$n = new ts, this.Fn = new Fs(this.$n, t => this.Xi.ku(t));
    }
    start() {
    ...
    Ti(t) {
        let e = this.Fu[t.Cr()];
        return e || (e = new Ds(this.$n, this.Xi), this.Fu[t.Cr()] = e), e;
    }
    Ri() {
        return this.Ii;
    }
    ...
    Bu(t, e) {
        return Bn.Dn(Object.values(this.Fu).map(n => () => n.vr(t, e)));
    }
}
...
class xs {
    ...
    er(t, e, n) {
        return this.ju.er(n, e), this.zu.delete(n), Bn.resolve();
    }
    nr(t, e, n) {
        return this.ju.nr(n, e), this.zu.add(n), Bn.resolve();
    }
    uu(t, e) {
    ...
    Hu(t, e) {
        return Bn.Dn([ () => Bn.resolve(this.ju.vr(e)), () => this.persistence.Ri().vr(t, e), () => this.persistence.Bu(t, e) ]);
    }
}
 ...
 */ class js {
    ...
    pc(t) {
        const e = Bs(t.ic.s), n = (s = t.ic, new qs(s));
        var s;
    ...
    gc(t) {
        return new Es(this.ko, this.xo, t.Is, t => this.lh.na(t, 0 /* RemoteStore */), Ms.Tc() ? new Ms : new Us);
    }
    vc(t) {
...
/** The result of parsing document data (e.g. for a setData call). */ class Fi {
    ...
    zc(t, e) {
        const n = [];
        return null !== this.qe ? n.push(new ze(t, this.data, this.qe, e)) : n.push(new Ke(t, this.data, e)), 
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Ni {
    ...
    zc(t, e) {
        const n = [ new ze(t, this.data, this.qe, e) ];
...
/** A "context" object passed around while parsing user data. */ class ki {
    ...
    /** Returns a new context with the specified settings overwritten. */    Yc(t) {
        return new ki(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.qe);
    }
    Xc(t) {
        var e;
    ...
    Oc(t) {
        return Ki(t, this.settings.methodName, this.settings.el || !1, this.path, this.settings.qc);
    }
 ...
 */ class Hi {
     ...
     */    Be(t) {
        ...
        return !this.ol.has(t) && e ? qe.updateTime(e) : qe.je();
    }
    /**
...
class Yi {
    constructor(t, e, n, s) {
        this.Is = t, this.xo = e, this.updateFunction = n, this.Ps = s, this.ll = 5, this.$s = new Kn(this.Is, "transaction_retry" /* TransactionRetry */);
    }
    ...
    _l() {
        this.$s.ds(async () => {
            const t = new Hi(this.xo), e = this.fl(t);
            e && e.then(e => {
...
class Xi {
     ...
     */    start(t, e, n, s) {
        ...
        return this.credentials.xr(t => {
            if (!r) return r = !0, m("FirestoreClient", "Initializing. user=", t.uid), this.El(e, n, s, t, i).then(this.Tl.resolve, this.Tl.reject);
        ...
        return this.ml(), await this.Tl.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    ...
                    /* usePreviousResults= */ !0), i = new Vs(n, t.dr), r = i.zh(t.documents), o = i.Jh(r, 
                    /* updateLimboDocuments= */ !1);
 ...
 */ (this.Is, this.Il, t, e);
     ...
     */    transaction(t) {
        this.ml();
        const e = new Gn;
        return this.Is.gs(() => (new Yi(this.Is, this.xo, t, e).run(), Promise.resolve())), 
        e.promise;
    }
}
...
class er {
    constructor(t) {
        ...
        ei("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Zn.ii; else {
            if (t.cacheSizeBytes !== tr && t.cacheSizeBytes < Zn.si) throw new k($.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Zn.si);
 ...
 */ class nr {
    ...
    get jl() {
        ...
        this.Gl = new xi(this.jc, this.Ql.ignoreUndefinedProperties)), this.Gl;
    }
    settings(t) {
        Hs("Firestore.settings", arguments, 1), Js("Firestore.settings", "object", 1, t);
        const e = new er(t);
        if (this.Ml && !this.Ql.isEqual(e)) throw new k($.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.Ml) throw new k($.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.Ml && !this.Ml.pl) throw new k($.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new Gn;
    ...
    onSnapshotsInSync(t) {
        if (this.ql(), Gs(t)) return this.Ml.Qa(t);
        {
    ...
    ql() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.zl(new Qs, new js, {
            Vc: !1
        }), this.Ml;
    }
    Xl() {
        return new b(this.jc, this.Bl, this.Ql.host, this.Ql.ssl, this.Ql.forceLongPolling);
    }
    zl(t, e, n) {
        const s = this.Xl();
        return this.Ml = new Xi(this.Wl, this.Ol), this.Ml.start(s, t, e, n);
    }
    static Ul(t) {
 ...
 */        const s = t.options.projectId;
    ...
    get app() {
        if (!this.Ll) throw new k($.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Ll;
    }
    collection(t) {
        return Hs("Firestore.collection", arguments, 1), Js("Firestore.collection", "non-empty string", 1, t), 
        this.ql(), new mr(q.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Hs("Firestore.doc", arguments, 1), Js("Firestore.doc", "non-empty string", 1, t), 
        this.ql(), rr.Jl(q.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
 ...
 */ class sr {
    ...
    get(t) {
        ...
        const e = Ar("Transaction.get", t, this.t_);
        return this.e_.hl([ e.Gc ]).then(t => {
            if (!t || 1 !== t.length) return A();
            const n = t[0];
            if (n instanceof hn) return new hr(this.t_, e.Gc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            if (n instanceof on) return new hr(this.t_, e.Gc, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            throw A();
        });
    ...
    set(t, e, n) {
        ...
        const s = Ar("Transaction.set", t, this.t_);
        n = Er("Transaction.set", n);
        const i = Vr(s.Kc, e, n), r = Li(this.t_.jl, "Transaction.set", s.Gc, i, null !== s.Kc, n);
        return this.e_.set(s.Gc, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof Ei ? (Ys("Transaction.update", arguments, 3), 
        i = Ar("Transaction.update", t, this.t_), r = qi(this.t_.jl, "Transaction.update", i.Gc, e, n, s)) : (Hs("Transaction.update", arguments, 2), 
        i = Ar("Transaction.update", t, this.t_), r = Oi(this.t_.jl, "Transaction.update", i.Gc, e)), 
        this.e_.update(i.Gc, r), this;
    }
    delete(t) {
        Hs("Transaction.delete", arguments, 1);
        const e = Ar("Transaction.delete", t, this.t_);
...
class ir {
    ...
    set(t, e, n) {
        Xs("WriteBatch.set", arguments, 2, 3), this.i_();
        const s = Ar("WriteBatch.set", t, this.t_);
        n = Er("WriteBatch.set", n);
        const i = Vr(s.Kc, e, n), r = Li(this.t_.jl, "WriteBatch.set", s.Gc, i, null !== s.Kc, n);
        return this.n_ = this.n_.concat(r.zc(s.Gc, qe.je())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.i_(), "string" == typeof e || e instanceof Ei ? (Ys("WriteBatch.update", arguments, 3), 
        i = Ar("WriteBatch.update", t, this.t_), r = qi(this.t_.jl, "WriteBatch.update", i.Gc, e, n, s)) : (Hs("WriteBatch.update", arguments, 2), 
        i = Ar("WriteBatch.update", t, this.t_), r = Oi(this.t_.jl, "WriteBatch.update", i.Gc, e)), 
        this.n_ = this.n_.concat(r.zc(i.Gc, qe.exists(!0))), this;
    }
    delete(t) {
        Hs("WriteBatch.delete", arguments, 1), this.i_();
        const e = Ar("WriteBatch.delete", t, this.t_);
        return this.n_ = this.n_.concat(new Ze(e.Gc, qe.je())), this;
    }
    commit() {
        return this.i_(), this.s_ = !0, this.n_.length > 0 ? this.t_.ql().write(this.n_) : Promise.resolve();
    }
    i_() {
        if (this.s_) throw new k($.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class rr extends Di {
    ...
    set(t, e) {
        ...
        const n = Vr(this.Kc, t, e), s = Li(this.firestore.jl, "DocumentReference.set", this.Gc, n, null !== this.Kc, e);
        return this.Ml.write(s.zc(this.Gc, qe.je()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof Ei ? (Ys("DocumentReference.update", arguments, 2), 
        s = qi(this.firestore.jl, "DocumentReference.update", this.Gc, t, e, n)) : (Hs("DocumentReference.update", arguments, 1), 
        s = Oi(this.firestore.jl, "DocumentReference.update", this.Gc, t)), this.Ml.write(s.zc(this.Gc, qe.exists(!0)));
    }
    delete() {
        return Hs("DocumentReference.delete", arguments, 0), this.Ml.write([ new Ze(this.Gc, qe.je()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        return this.Ml.listen(ln(this.Gc.path), o, h);
    }
    get(t) {
        Xs("DocumentReference.get", arguments, 0, 1), Rr("DocumentReference.get", t);
        const e = this.firestore.ql();
        return t && "cache" === t.source ? e.Al(this.Gc).then(t => new hr(this.firestore, this.Gc, t, 
        /*fromCache=*/ !0, t instanceof on && t.Ge, this.Kc)) : e.Pl(this.Gc, t).then(t => this.r_(t));
    }
    withConverter(t) {
...
class hr {
    ...
    data(t) {
        ...
        this.o_) {
            ...
            if (this.Kc) {
                const e = new ar(this.t_, this.Gc, this.o_, this.h_, this.a_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(e, t);
            }
            return new Zi(this.t_.jc, this.t_.Zl(), t.serverTimestamps || "none", t => new rr(t, this.t_, /* converter= */ null)).bl(this.o_.Ze());
        }
    }
    get(t, e) {
        if (Xs("DocumentSnapshot.get", arguments, 1, 2), e = Ir("DocumentSnapshot.get", e), 
        this.o_) {
            const n = this.o_.data().field(ji("DocumentSnapshot.get", t, this.Gc));
            if (null !== n) {
                return new Zi(this.t_.jc, this.t_.Zl(), e.serverTimestamps || "none", t => new rr(t, this.t_, this.Kc)).bl(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new rr(this.Gc, this.t_, this.Kc);
    }
    get exists() {
        return null !== this.o_;
    }
    get metadata() {
        return new or(this.a_, this.h_);
    }
    isEqual(t) {
...
class wr {
    ...
    where(t, e, n) {
        ...
        const i = ji("Query.where", t), r = ur(this.u_, "Query.where", this.firestore.jl, this.firestore.jc, i, s, n);
    ...
    orderBy(t, e) {
        ...
        const s = ji("Query.orderBy", t), i = cr(this.u_, s, n);
        return new wr(function(t, e) {
    ...
    limit(t) {
        ...
        new wr(wn(this.u_, t, "F" /* First */), this.firestore, this.Kc);
    }
    limitToLast(t) {
        return Hs("Query.limitToLast", arguments, 1), Js("Query.limitToLast", "number", 1, t), 
        li("Query.limitToLast", 1, t), new wr(wn(this.u_, t, "L" /* Last */), this.firestore, this.Kc);
    }
    startAt(t, ...e) {
        Ys("Query.startAt", arguments, 1);
        const n = this.c_("Query.startAt", t, e, 
        /*before=*/ !0);
        return new wr(Tn(this.u_, n), this.firestore, this.Kc);
    }
    startAfter(t, ...e) {
    ...
    endBefore(t, ...e) {
        ...
        /*before=*/ !0);
        return new wr(mn(this.u_, n), this.firestore, this.Kc);
    }
    endAt(t, ...e) {
    ...
    isEqual(t) {
        ...
        return this.firestore === t.firestore && En(this.u_, t.u_) && this.Kc === t.Kc;
    }
    withConverter(t) {
        return new wr(this.u_, this.firestore, t);
    }
 ...
 */ (this.u_, this.firestore.jc, t, e.o_, s);
    ...
    onSnapshot(...t) {
        ...
        const o = {
            next: e => {
                t[r] && t[r](new Tr(this.firestore, this.u_, e, this.Kc));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
    ...
    get(t) {
        Xs("Query.get", arguments, 0, 1), Rr("Query.get", t), dr(this.u_);
        const e = this.firestore.ql();
        return (t && "cache" === t.source ? e.Vl(this.u_) : e.yl(this.u_, t)).then(t => new Tr(this.firestore, this.u_, t, this.Kc));
    }
}
...
class Tr {
    ...
    get query() {
        return new wr(this.l_, this.t_, this.Kc);
    }
    docChanges(t) {
        ...
        if (e && this.__.Ut) throw new k($.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        ...
        return this.t_ === t.t_ && En(this.l_, t.l_) && this.__.isEqual(t.__) && this.Kc === t.Kc;
    }
    w_(t, e, n) {
        return new ar(this.t_, t.key, t, e, n, this.Kc);
    }
}

class mr extends wr {
    constructor(t, e, n) {
        if (super(ln(t), e, n), this.T_ = t, t.length % 2 != 1) throw new k($.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t.N()} has ${t.length}`);
    }
    get id() {
    ...
    doc(t) {
        ...
        const e = q.$(t);
        return rr.Jl(this.u_.path.child(e), this.firestore, this.Kc);
    }
    add(t) {
    ...
    withConverter(t) {
        return new mr(this.T_, this.firestore, t);
    }
}
...
function pr(t) {
    ...
    }(t, (t, e) => new nr(t, e, new Qs, new js)), t.registerVersion("@firebase/firestore", "1.16.4");
}
