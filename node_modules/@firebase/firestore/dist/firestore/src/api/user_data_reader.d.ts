...
export interface UntypedFirestoreDataConverter<T> {
    ...
    toFirestore(modelObject: Partial<T>, options: firestore.SetOptions): firestore.DocumentData;
...
export declare function parseSetData(userDataReader: UserDataReader, methodName: string, targetDoc: DocumentKey, input: unknown, hasConverter: boolean, options?: firestore.SetOptions): ParsedSetData;
 ...
 */
export declare function parseQueryValue(userDataReader: UserDataReader, methodName: string, input: unknown, allowArrays?: boolean): api.Value;
/**
