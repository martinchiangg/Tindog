 ...
 */ (n, e) : t instanceof Ce ? De(t, e) : t instanceof Fe ? Ne(t, e) : function(t, e) {
        ...
        return Kt(n) && Kt(t.Me) ? ee(s) : ne(t.serializer, s);
    }(t, e);
}
 ...
 */ function wn(t) {
    ...
    if (null === e.nn) {
        ...
        t.O() || e.nn.push(new qn(t)), e.nn.push(new qn(B.q(), "asc" /* ASCENDING */)); else {
            let t = !1;
...
class pn extends class {} {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.dn(qt(e, this.value)) : null !== e && xt(this.value) === xt(e) && this.dn(qt(e, this.value));
...
class Zn {
     ...
     */    async Us(t) {
        if (this.Os(), !this.Ss) {
            this.Ss = !0;
            const e = Xn();
            e && "function" == typeof e.removeEventListener && e.removeEventListener("visibilitychange", this.ks), 
            await this.Ms(t);
        }
    }
    /**
     ...
     */    enqueue(t) {
        return this.Os(), this.Ss ? new Promise(t => {}) : this.qs(t);
    }
    /**
     ...
     */    Bs(t) {
        this.bs.push(t), this.gs(() => this.Ws());
    }
    /**
 ...
 */ (t)), t;
     ...
     */    Ts(t, e, n) {
        ...
        const s = Jn.Vs(this, t, e, n, t => this.Qs(t));
...
class rs {
    ...
    t, e, n) {
         ...
         */
        this.wi = O.min(), this.Nn = t.Ti(n), this.mi = t.Ei(), this.Ii = t.Ri(), this.Ai = new jn(this.mi, this.Nn, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
    async yi(t) {
        let e = this.Nn, n = this.Ai;
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            // Swap out the mutation queue, grabbing the pending mutation batches
            // before and after.
            let i;
            return this.Nn.pi(s).next(r => (i = r, e = this.persistence.Ti(t), 
            // Recreate our LocalDocumentsView using the new
            // MutationQueue.
            n = new jn(this.mi, e, this.persistence.Pi()), e.pi(s))).next(t => {
                const e = [], r = [];
        ...
        return this.Nn = e, this.Ai = n, this._i.Vi(this.Ai), s;
    }
    Si(t) {
        const e = L.now(), n = t.reduce((t, e) => t.add(e.key), Et());
        let s;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", i => this.Ai.Mn(i, n).next(n => {
            s = n;
    ...
    Fi(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            const n = t.batch.keys(), s = this.mi.Ni({
                $i: !0
            });
            return this.ki(e, t, s).next(() => s.apply(e)).next(() => this.Nn.xi(e)).next(() => this.Ai.Mn(e, n));
        });
    }
    Li(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.Nn.Oi(e, t).next(t => (V(null !== t), n = t.keys(), this.Nn.qi(e, t))).next(() => this.Nn.xi(e)).next(() => this.Ai.Mn(e, n));
        });
    }
    Mi() {
    ...
    Ui() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Ii.Ui(t));
    }
    Bi(t) {
        const e = t.J;
        let n = this.fi;
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Wt.forEach((t, i) => {
                ...
                // the updated assignment.
                                r.push(this.Ii.Wi(s, t.Jt, i).next(() => this.Ii.Qi(s, t.Yt, i)));
                const h = t.resumeToken;
                // Update the resume token if the change includes one.
                                if (h.H() > 0) {
                    const a = o.tt(h, e).Z(s.ji);
                    n = n.nt(i, a), 
                    // Update the target data if there are target changes (or if
                    // sufficient time has passed since the last update).
                    rs.Gi(o, a, t) && r.push(this.Ii.Ki(s, a));
                }
            });
            let o = _t(), h = Et();
            ...
            r.push(i.getEntries(s, h).next(n => {
                t.jt.forEach((h, a) => {
                    ...
                    // access.
                    i.zi(h, e), o = o.nt(h, a)) : null == u || a.version.o(u.version) > 0 || 0 === a.version.o(u.version) && u.hasPendingWrites ? (i.Hi(a, e), 
                    o = o.nt(h, a)) : E("LocalStore", "Ignoring outdated watch update for ", h, ". Current version:", u.version, " Watch version:", a.version), 
                    t.Gt.has(h) && r.push(this.persistence.Xi.Yi(s, h));
                });
            })), !e.isEqual(O.min())) {
                const t = this.Ii.Ui(s).next(t => this.Ii.Ji(s, s.ji, e));
                r.push(t);
            }
            return Qn.Cn(r).next(() => i.apply(s)).next(() => this.Ai.Un(s, o));
        }).then(t => (this.fi = n, t));
    }
    /**
     ...
     */    static Gi(t, e, n) {
        ...
        // closing.
                if (e.J.I() - t.J.I() >= this.Zi) return !0;
    ...
    async tr(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => Qn.forEach(t, t => Qn.forEach(t.Yn, n => this.persistence.Xi.er(e, t.targetId, n)).next(() => Qn.forEach(t.Xn, n => this.persistence.Xi.nr(e, t.targetId, n)))));
        } catch (t) {
            if (!Yn(t)) throw t;
        ...
        for (const e of t) {
            const t = e.targetId;
            if (!e.fromCache) {
                const e = this.fi.get(t), n = e.J, s = e.et(n);
                // Advance the last limbo free snapshot version
                                this.fi = this.fi.nt(t, s);
            }
        }
    }
    sr(t) {
    ...
    rr(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.Ai.kn(e, t));
    }
    or(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let n;
            return this.Ii.hr(e, t).next(s => s ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            n = s, Qn.resolve(n)) : this.Ii.ar(e).next(s => (n = new tt(t, s, 0 /* Listen */ , e.ji), 
            this.Ii.ur(e, n).next(() => n))));
        }).then(e => {
            // If Multi-Tab is enabled, the existing target data may be newer than
            // the in-memory data
            const n = this.fi.get(e.targetId);
            return (null === n || e.J.o(n.J) > 0) && (this.fi = this.fi.nt(e.targetId, e), this.di.set(t, e.targetId)), 
            e;
        });
    }
    hr(t, e) {
        const n = this.di.get(e);
        return void 0 !== n ? Qn.resolve(this.fi.get(n)) : this.Ii.hr(t, e);
    }
    async cr(t, e) {
        const n = this.fi.get(t), s = e ? "readwrite" : "readwrite-primary";
        try {
            e || await this.persistence.runTransaction("Release target", s, t => this.persistence.Xi.removeTarget(t, n));
        } catch (e) {
            if (!Yn(e)) throw e;
        ...
        this.fi = this.fi.remove(t), this.di.delete(n.target);
    }
    lr(t, e) {
        let n = O.min(), s = Et();
        return this.persistence.runTransaction("Execute query", "readonly", i => this.hr(i, Tn(t)).next(t => {
            if (t) return n = t.lastLimboFreeSnapshotVersion, this.Ii._r(i, t.targetId).next(t => {
                s = t;
            });
        }).next(() => this._i.Wn(i, t, e ? n : O.min(), e ? s : Et())).next(t => ({
            documents: t,
            dr: s
        })));
    }
    ki(t, e, n) {
        ...
        }), r.next(() => this.Nn.qi(t, s));
    }
    wr(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.Tr(e, this.fi));
    }
}
...
class hs {
    constructor() {
        ...
        this.mr = new ut(as.Er), 
        // A set of outstanding references to a document sorted by target id.
        this.Ir = new ut(as.Rr);
    }
    ...
    /** Add references to the given document keys for the given ID. */    Ar(t, e) {
     ...
     * removed.
     */    yr(t) {
        const e = new W(new M([])), n = new as(e, t), s = new as(e, t + 1), i = [];
        return this.Ir.bt([ n, s ], t => {
            this.Pr(t), i.push(t.key);
        }), i;
    }
    pr() {
        this.mr.forEach(t => this.Pr(t));
    }
    Pr(t) {
        this.mr = this.mr.delete(t), this.Ir = this.Ir.delete(t);
    }
    gr(t) {
        const e = new W(new M([])), n = new as(e, t), s = new as(e, t + 1);
        let i = Et();
        return this.Ir.bt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    vr(t) {
        const e = new as(t, 0), n = this.mr.Ct(e);
...
class as {
    ...
    /** Compare by key then by ID */    static Er(t, e) {
        return W.P(t.key, e.key) || v(t.br, e.br);
    }
    /** Compare by ID then by key */    static Rr(t, e) {
        return v(t.br, e.br) || W.P(t.key, e.key);
    }
}
...
us.Dr = new us("google-credentials-uid"), us.Fr = new us("first-party-uid");
...
class _s {
    constructor(t) {
        ...
        this.currentUser = us.UNAUTHENTICATED, this.qr = !1, 
        /**
        ...
        this.$r = null, this.forceRefresh = !1, this.Or = () => {
            this.Mr++, this.currentUser = this.Ur(), this.qr = !0, this.$r && this.$r(this.currentUser);
        }, this.Mr = 0, this.auth = t.getImmediate({
            optional: !0
        }), this.auth ? this.auth.addAuthTokenListener(this.Or) : (
        // if auth is not available, invoke tokenListener once with null token
        this.Or(null), t.get().then(t => {
            this.auth = t, this.Or && 
            // tokenListener can be removed by removeChangeListener()
            this.auth.addAuthTokenListener(this.Or);
        }, () => {}));
    }
    getToken() {
 ...
 */ class fs {
    constructor(t, e) {
        this.Br = t, this.Wr = e, this.type = "FirstParty", this.user = us.Fr;
    }
    get Nr() {
        const t = {
 ...
 */ class ds {
    ...
    getToken() {
        return Promise.resolve(new fs(this.Br, this.Wr));
    }
    xr(t) {
...
class ws {
    constructor(t, e, n, s, i, r) {
        this.rs = t, this.jr = n, this.Gr = s, this.Kr = i, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.zr = 0, this.Hr = null, this.stream = null, this.$s = new Hn(t, e);
    }
    /**
     ...
     */    async stop() {
        this.Yr() && await this.close(0 /* Initial */);
    }
    /**
     ...
     */    to() {
        ...
        this.Xr() && null === this.Hr && (this.Hr = this.rs.Ts(this.jr, 6e4, () => this.eo()));
    }
    /** Sends a message to the underlying stream. */    no(t) {
        this.so(), this.stream.send(t);
    }
    /** Called by the idle timer when the stream should close due to inactivity. */    async eo() {
        if (this.Xr()) 
        // When timing out an idle stream there's no reason to force the stream into backoff when
        // it restarts so set the stream state to Initial instead of Error.
        return this.close(0 /* Initial */);
    }
    /** Marks the stream as active again. */    so() {
    ...
    auth() {
        ...
        const t = this.oo(this.zr), e = this.zr;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.Kr.getToken().then(t => {
    ...
    ho(t) {
        const e = this.oo(this.zr);
        this.stream = this.uo(t), this.stream.co(() => {
            e(() => (this.state = 2 /* Open */ , this.listener.co()));
        }), this.stream.ro(t => {
            e(() => this.ao(t));
     ...
     */    oo(t) {
        return e => {
            this.rs.gs(() => this.zr === t ? e() : (E("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class Ts extends ws {
     ...
     */    do(t) {
        const e = {};
        e.database = _e(this.serializer), e.removeTarget = t, this.no(e);
    }
}
 ...
 */ class ms extends ws {
    ...
    onMessage(t) {
        ...
        V(!!t.streamToken), this.lastStreamToken = t.streamToken, this.wo) {
        ...
        return V(!t.writeResults || 0 === t.writeResults.length), this.wo = !0, this.listener.Io();
    }
    /**
     ...
     */    Ro() {
        ...
        const t = {};
        t.database = _e(this.serializer), this.no(t);
    }
    /** Sends a group of mutations to the Firestore backend to apply. */    mo(t) {
        const e = {
...
class Es extends class {} {
    constructor(t, e, n) {
        super(), this.credentials = t, this.Gr = e, this.serializer = n, this.Ao = !1;
    }
    Po() {
        if (this.Ao) throw new x(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Vo(t, e, n) {
        return this.Po(), this.credentials.getToken().then(s => this.Gr.Vo(t, e, n, s)).catch(t => {
            throw t.code === k.UNAUTHENTICATED && this.credentials.kr(), t;
        });
    }
    /** Gets an auth token and invokes the provided RPC with streamed results. */    yo(t, e, n) {
        return this.Po(), this.credentials.getToken().then(s => this.Gr.yo(t, e, n, s)).catch(t => {
            throw t.code === k.UNAUTHENTICATED && this.credentials.kr(), t;
        });
    }
    terminate() {
...
class Is {
     ...
     */    Co() {
        0 === this.vo && (this.Do("Unknown" /* Unknown */), this.bo = this.Is.Ts("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.bo = null, 
    ...
    e, n, s, i) {
        ...
        this.Mo = new Set, this.Uo = i, this.Uo.Bo(t => {
            n.gs(async () => {
                ...
                // down our streams.
                this.Wo() && (E("RemoteStore", "Restarting streams for network reachability change."), 
                await this.Qo());
            });
        }), this.jo = new Is(n, s), 
        ...
        this.Go = function(t, e, n) {
            const s = y(t);
            return s.Po(), new Ts(e, s.Gr, s.credentials, s.serializer, n);
        }
        /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (this.xo, n, {
            ...
            const s = y(t);
            return s.Po(), new ms(e, s.Gr, s.credentials, s.serializer, n);
        }(this.xo, n, {
    ...
    async ih() {
        await this.Yo.stop(), await this.Go.stop(), this.Lo.length > 0 && (E("RemoteStore", `Stopping write stream with ${this.Lo.length} pending writes`), 
        this.Lo = []), this.rh();
    }
    async oh() {
        E("RemoteStore", "RemoteStore shutting down."), this.Mo.add(5 /* Shutdown */), await this.ih(), 
        this.Uo.oh(), 
    ...
    async Ho(t, e) {
        ...
        try {
            ...
            await this.fh(e);
        } else if (t instanceof gt ? this.qo.Pe(t) : t instanceof vt ? this.qo.Ce(t) : this.qo.pe(t), 
        !e.isEqual(O.min())) try {
            const t = await this.ko.Ui();
            e.o(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.dh(e);
        } catch (t) {
            E("RemoteStore", "Failed to raise snapshot:", t), await this.fh(t);
        }
    }
    /**
     ...
     */    async sh() {
        ...
        for (;this.mh(); ) try {
            const e = await this.ko.sr(t);
            if (null === e) {
                0 === this.Lo.length && this.Yo.to();
                break;
            }
    ...
    async Zo() {
        ...
        for (const t of this.Lo) this.Yo.mo(t.mutations);
    }
    async Eo(t, e) {
        const n = this.Lo.shift(), s = Wn.from(n, t, e);
    ...
    async Vh(t) {
        ...
        if (it(e = t.code) && e !== k.ABORTED) {
            ...
            // restart.
                        this.Yo.Zr(), await this.wh(() => this.lh.yh(e.batchId, t)), 
 ...
 */    }
    async Qo() {
        ...
        this.Yo.Zr(), this.Go.Zr(), this.Mo.delete(4 /* ConnectivityChange */), await this.th();
    }
    async ph(t) {
        this.Is.js(), 
        ...
        await this.ih(), this.jo.set("Unknown" /* Unknown */), await this.lh.ph(t), this.Mo.delete(3 /* CredentialChange */), 
        await this.th();
    }
    /**
 ...
 */ class Ps {
    constructor() {
        this.Ch = new As, this.Dh = {}, this.po = null, this.Zn = null;
    }
    Fh(t) {
        // No op.
    }
    ...
    start() {
        return this.Ch = new As, Promise.resolve();
    }
    yi(t, e, n) {
        // No op.
    }
 ...
 */ class ps {
    ...
    e) {
        ...
        this.qt = Et(), this.jh = yn(t), this.Gh = new At(this.jh);
    }
    /**
 ...
 */ (t.type, e.type) || this.jh(t.doc, e.doc)), this.Zh(n);
    ...
    ta() {
        ...
        // updating many documents.
                const t = this.Qh;
        this.Qh = Et(), this.Gh.forEach(t => {
            this.sa(t.key) && (this.Qh = this.Qh.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Qh.has(t) || e.push(new ys(t));
        }), this.Qh.forEach(n => {
    ...
    // PORTING NOTE: Multi-tab only.
    ia(t) {
        this.Bh = t.dr, this.Qh = Et();
        const e = this.zh(t.documents);
 ...
 */ class bs {
    ...
    s, i, r) {
         ...
         */
        this.wa = new Map, this.Ta = new hs, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ma = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Ea = new Map, this.Ia = is.li(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async listen(t) {
        ...
        e = s.targetId, this.aa.$h(e), n = s.view.ra(); else {
            const s = await this.ko.or(Tn(t)), i = this.aa.$h(s.targetId);
     ...
     * snapshot.
     */    async Va(t, e, n) {
        const s = await this.ko.lr(t, 
        /* usePreviousResults= */ !0), i = new ps(t, s.dr), r = i.zh(s.documents), o = pt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jh(r, 
    ...
    async ah(t) {
        ...
        // No other queries are mapped to the target, clean up the query and the target.
            ...
            this.aa.Mh(e.targetId) || await this.ko.cr(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.aa.Oh(e.targetId), this.ha.ah(e.targetId), this.pa(e.targetId);
            }).catch(os);
        } else this.pa(e.targetId), await this.ko.cr(e.targetId, 
        /*keepPersistedTargetData=*/ !0);
    }
    async write(t, e) {
        this.Pa("write()");
        try {
            const n = await this.ko.Si(t);
            this.aa.Fh(n.batchId), this.ga(n.batchId, e), await this.va(n.Di), await this.ha.sh();
        } catch (t) {
    ...
    na(t, e) {
        ...
        if (this.Aa && 0 /* RemoteStore */ === e || !this.Aa && 1 /* SharedClientState */ === e) {
            ...
            }), this.ca.ba(t), this.ca._o(e), this.onlineState = t, this.Aa && this.aa.Uh(t);
        }
    }
    async Th(t, e) {
        ...
        } else await this.ko.cr(t, /* keepPersistedTargetData */ !1).then(() => this.pa(t, e)).catch(os);
    }
    async Ph(t) {
        this.Pa("applySuccessfulWrite()");
        const e = t.batch.batchId;
        try {
            const n = await this.ko.Fi(t);
    ...
    ga(t, e) {
        let n = this.ma[this.currentUser.Cr()];
        n || (n = new ot(v)), n = n.nt(t, e), this.ma[this.currentUser.Cr()] = n;
    }
    /**
     ...
     */    Ca(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            const s = n.get(t);
            s && (e ? s.reject(e) : s.resolve(), n = n.remove(t)), this.ma[this.currentUser.Cr()] = n;
        }
    }
    pa(t, e = null) {
        this.aa.xh(t);
    ...
    ya(t, e) {
        for (const n of e) if (n instanceof Vs) this.Ta.er(n.key, t), this.xa(n); else if (n instanceof ys) {
            E("SyncEngine", "Document no longer in limbo: " + n.key), this.Ta.nr(n.key, t);
            this.Ta.vr(n.key) || 
            // We removed the last reference for this key
            this.ka(n.key);
        } else P();
     ...
     */    Sa() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new vs(t)), this.da = this.da.nt(t, e), this.ha.listen(new tt(Tn(fn(t.path)), e, 2 /* LimboResolution */ , Kn.ss));
        }
    }
    // Visible for testing
    La() {
    ...
    async va(t, e) {
        ...
        this.la.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                const e = o.view.zh(t);
                return e.Xh ? this.ko.lr(o.query, /* usePreviousResults= */ !1).then(({documents: t}) => o.view.zh(t, e)) : e;
                ...
                if (this.ya(o.targetId, r.ea), r.snapshot) {
        ...
        }), await Promise.all(i), this.ca._o(n), await this.ko.tr(s);
    }
    Pa(t) {}
    async ph(t) {
        if (!this.currentUser.isEqual(t)) {
            E("SyncEngine", "User change. New user:", t.Cr());
            const e = await this.ko.yi(t);
            this.currentUser = t, 
            // Fails tasks waiting for pending writes requested by previous user.
            this.Na("'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            this.aa.yi(t, e.vi, e.bi), await this.va(e.gi);
        }
    }
    xe(t) {
        const e = this.wa.get(t);
        if (e && e.oa) return Et().add(e.key);
        {
            let e = Et();
 ...
 */ class Ds {
    ...
    Xa(t) {
        t = Vt.Bt(t.query, t.docs, t.qt, t.fromCache), this.Ka = !0, this.Ga.next(t);
    }
}
 ...
 */ class Fs {
    ...
    Wn(t, e, s, i) {
        ...
        return e.on() || s.isEqual(O.min()) ? this.tu(t, e) : this.Za.Mn(t, i).next(r => {
            const o = this.eu(e, r);
            return (e.hn() || e.an()) && this.Xh(e.en, o, i, s) ? this.tu(t, e) : (m() <= n.DEBUG && E("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), Pn(e)), 
 ...
 */ class Ns {
    ...
    Ci(t, e, n, s) {
        ...
        for (const e of s) this.su = this.su.add(new as(e.key, i)), this.$n.ai(t, e.key.path.g());
        return Qn.resolve(r);
    }
    Oi(t, e) {
    ...
    qi(t, e) {
        ...
        return Qn.forEach(e.mutations, s => {
            ...
            return n = n.delete(i), this.Xi.uu(t, s.key);
        }).next(() => {
            this.su = n;
        });
    }
 ...
 */ class $s {
     ...
     */    Hi(t, e, n) {
        ...
        return this.docs = this.docs.nt(s, {
            ...
            size: o,
            readTime: n
        }), this.size += o - r, this.$n.ai(t, s.path.g());
    }
    /**
 ...
 */ $s.du = class extends class {
    constructor() {
        ...
        this.Di = new $(t => t.toString(), (t, e) => t.isEqual(e)), this.Tu = !1;
    }
    set readTime(t) {
        this.mu = t;
    }
 ...
 */ {
    ...
    Jh(t) {
        ...
        return this.Di.forEach((n, s) => {
            s ? e.push(this.Au.Hi(t, s, this.readTime)) : this.Au.zi(n);
        }), Qn.Cn(e);
    }
    Iu(t, e) {
...
class ks {
    constructor(t) {
         ...
         * IDs.
         */
        this.yu = new hs, this.targetCount = 0, this.pu = is.ci();
    }
    ge(t, e) {
    ...
    Qi(t, e, n) {
        return this.yu.Ar(e, n), Qn.resolve();
    }
    Wi(t, e, n) {
        this.yu.Vr(e, n);
        const s = this.persistence.Xi, i = [];
        return s && e.forEach(e => {
            i.push(s.uu(t, e));
        }), Qn.Cn(i);
    }
    Cu(t, e) {
        return this.yu.yr(e), Qn.resolve();
    }
    _r(t, e) {
        const n = this.yu.gr(e);
        return Qn.resolve(n);
    }
    vr(t, e) {
        return Qn.resolve(this.yu.vr(e));
    }
}
...
class xs {
     ...
     */
    constructor(t) {
        this.Fu = {}, this.Nu = new Kn(0), this.$u = !1, this.$u = !0, this.Xi = t(this), 
        this.Ii = new ks(this);
        this.$n = new ns, this.Fn = new $s(this.$n, t => this.Xi.ku(t));
    }
    start() {
    ...
    Ti(t) {
        let e = this.Fu[t.Cr()];
        return e || (e = new Ns(this.$n, this.Xi), this.Fu[t.Cr()] = e), e;
    }
    Ri() {
        return this.Ii;
    }
    ...
    runTransaction(t, e, n) {
        ...
        return this.Xi.qu(), n(s).next(t => this.Xi.Mu(s).next(() => t)).bn().then(t => (s.Uu(), 
        t));
    }
    Bu(t, e) {
        return Qn.Dn(Object.values(this.Fu).map(n => () => n.vr(t, e)));
    }
}
...
class Os {
    ...
    er(t, e, n) {
        return this.ju.er(n, e), this.zu.delete(n), Qn.resolve();
    }
    nr(t, e, n) {
        return this.ju.nr(n, e), this.zu.add(n), Qn.resolve();
    }
    uu(t, e) {
        return this.zu.add(e), Qn.resolve();
    }
    removeTarget(t, e) {
        this.ju.yr(e.targetId).forEach(t => this.zu.add(t));
        const n = this.persistence.Ri();
        return n._r(t, e.targetId).next(t => {
    ...
    Mu(t) {
        ...
        const e = this.persistence.Ei().Ni();
    ...
    Hu(t, e) {
        return Qn.Dn([ () => Qn.resolve(this.ju.vr(e)), () => this.persistence.Ri().vr(t, e), () => this.persistence.Bu(t, e) ]);
    }
}
...
class {
     ...
     */    ac(t, e) {
        ...
        t["Content-Type"] = "text/plain", e) for (const n in e.Nr) e.Nr.hasOwnProperty(n) && (t[n] = e.Nr[n]);
    }
    hc(t, e) {
        const n = Ms[t];
 ...
 */ class Ks {
    async initialize(t, e) {
        this.ko || (this.ko = t.ko, this.aa = t.aa, this.xo = this.pc(e), this.ha = this.gc(e), 
        this.lh = this.vc(e), this.bc = this.Sc(e), this.aa.po = t => this.lh.na(t, 1 /* SharedClientState */), 
        this.ha.lh = this.lh, await this.ha.start(), await this.ha.gh(this.lh.Aa));
    }
    Sc(t) {
        return new Cs(this.lh);
    }
    pc(t) {
    ...
    gc(t) {
        return new Rs(this.ko, this.xo, t.Is, t => this.lh.na(t, 0 /* RemoteStore */), Bs.Tc() ? new Bs : new Ws);
    }
    vc(t) {
...
/** A "context" object passed around while parsing user data. */ class xi {
    ...
    constructor(t, e, n, s, i, r) {
        ...
        void 0 === i && this.Hc(), this.fieldTransforms = i || [], this.qe = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Yc(t) {
        return new xi(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.qe);
    }
    Xc(t) {
        var e;
    ...
    Oc(t) {
        return zi(t, this.settings.methodName, this.settings.el || !1, this.path, this.settings.qc);
    }
...
/** Parse update data from an update() call. */ function qi(t, e, n, s) {
 ...
 */ class Yi {
    ...
    async hl(t) {
        ...
        const e = await async function(t, e) {
            ...
            }, r = await n.yo("BatchGetDocuments", s, i), o = new Map;
            r.forEach(t => {
    ...
    async commit() {
        ...
        t.forEach((t, e) => {
            ...
            await n.Vo("Commit", s, i);
        }(this.xo, this.mutations), this.il = !0;
    }
    ul(t) {
        let e;
...
class Xi {
    constructor(t, e, n, s) {
        this.Is = t, this.xo = e, this.updateFunction = n, this.Ps = s, this.ll = 5, this.$s = new Hn(this.Is, "transaction_retry" /* TransactionRetry */);
    }
    ...
    _l() {
        this.$s.ds(async () => {
            const t = new Yi(this.xo), e = this.fl(t);
            e && e.then(e => {
    ...
    dl(t) {
        this.ll > 0 && this.wl(t) ? (this.ll -= 1, this.Is.gs(() => (this._l(), Promise.resolve()))) : this.Ps.reject(t);
    }
    wl(t) {
...
class Ji {
     ...
     */    start(t, e, n, s) {
        ...
        return this.credentials.xr(t => {
            if (!r) return r = !0, E("FirestoreClient", "Initializing. user=", t.uid), this.El(e, n, s, t, i).then(this.Tl.resolve, this.Tl.reject);
            this.Is.Bs(() => this.ha.ph(t));
        }), 
        // Block the async queue until initialization is done
        this.Is.gs(() => this.Tl.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.ml(), this.Is.enqueue(() => (this.persistence.Ou(!0), this.ha.enableNetwork()));
    }
    /**
    ...
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.ml(), this.Is.enqueue(() => (this.persistence.Ou(!1), this.ha.disableNetwork()));
    }
    terminate() {
        return this.Is.Us(async () => {
     ...
     */    waitForPendingWrites() {
        this.ml();
        const t = new zn;
        return this.Is.gs(() => this.lh.Fa(t)), t.promise;
    }
    listen(t, e, n) {
        this.ml();
        const s = new Hs(n), i = new Ds(t, s, e);
        return this.Is.gs(() => this.Il.listen(i)), () => {
            s.Dc(), this.Is.gs(() => this.Il.ah(i));
        };
    }
    async Al(t) {
        return this.ml(), await this.Tl.promise, async function(t, e, n) {
            const s = new zn;
            return await t.enqueue(async () => {
                try {
                    const t = await e.rr(n);
 ...
 */ (this.Is, this.ko, t);
    ...
    async Pl(t, e) {
        return this.ml(), await this.Tl.promise, function(t, e, n, s) {
    ...
    async Vl(t) {
        return this.ml(), await this.Tl.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    const t = await e.lr(n, 
                    /* usePreviousResults= */ !0), i = new ps(n, t.dr), r = i.zh(t.documents), o = i.Jh(r, 
                    /* updateLimboDocuments= */ !1);
 ...
 */ (this.Is, this.Il, t, e);
    ...
    write(t) {
        this.ml();
        const e = new zn;
        return this.Is.gs(() => this.lh.write(t, e)), e.promise;
    }
    s() {
        return this.ic.s;
    }
    Qa(t) {
        this.ml();
        const e = new Hs(t);
        return this.Is.gs(async () => this.Il.Qa(e)), () => {
            e.Dc(), this.Is.gs(async () => this.Il.ja(e));
        };
    }
    get pl() {
     ...
     */    transaction(t) {
        this.ml();
        const e = new zn;
        return this.Is.gs(() => (new Xi(this.Is, this.xo, t, e).run(), Promise.resolve())), 
        e.promise;
    }
}
...
class tr {
    constructor(t, e, n, s) {
        this.s = t, this.timestampsInSnapshots = e, this.gl = n, this.vl = s;
    }
    bl(t) {
        switch (xt(t)) {
          case 0 /* NullValue */ :
    ...
    Nl(t) {
        return (t.values || []).map(t => this.bl(t));
    }
    Cl(t) {
        switch (this.gl) {
          case "previous":
...
class nr {
    constructor(t) {
        ...
        si("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = es.ii; else {
            if (t.cacheSizeBytes !== er && t.cacheSizeBytes < es.si) throw new x(k.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + es.si);
 ...
 */ class sr {
    ...
    get jl() {
        ...
        this.Gl = new Li(this.jc, this.Ql.ignoreUndefinedProperties)), this.Gl;
    }
    settings(t) {
        Xs("Firestore.settings", arguments, 1), ti("Firestore.settings", "object", 1, t);
        const e = new nr(t);
        if (this.Ml && !this.Ql.isEqual(e)) throw new x(k.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.Ml) throw new x(k.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.Ml && !this.Ml.pl) throw new x(k.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new zn;
        return this.Ol.Ls(async () => {
            try {
                await this.kl.clearPersistence(this.jc, this.Bl), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.ql(), zs(t)) return this.Ml.Qa(t);
        {
    ...
    ql() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.zl(new Gs, new Ks, {
            Vc: !1
        }), this.Ml;
    }
    Xl() {
        return new S(this.jc, this.Bl, this.Ql.host, this.Ql.ssl, this.Ql.forceLongPolling);
    }
    zl(t, e, n) {
        const s = this.Xl();
        return this.Ml = new Ji(this.Wl, this.Ol), this.Ml.start(s, t, e, n);
    }
    static Ul(t) {
 ...
 */        const s = t.options.projectId;
    ...
    get app() {
        if (!this.Ll) throw new x(k.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Ll;
    }
    collection(t) {
        return Xs("Firestore.collection", arguments, 1), ti("Firestore.collection", "non-empty string", 1, t), 
        this.ql(), new Er(M.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Xs("Firestore.doc", arguments, 1), ti("Firestore.doc", "non-empty string", 1, t), 
        this.ql(), or.Jl(M.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
 ...
 */ class ir {
    ...
    get(t) {
        ...
        const e = Pr("Transaction.get", t, this.t_);
        return this.e_.hl([ e.Gc ]).then(t => {
            if (!t || 1 !== t.length) return P();
            const n = t[0];
            if (n instanceof un) return new ar(this.t_, e.Gc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            if (n instanceof an) return new ar(this.t_, e.Gc, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            throw P();
        });
    ...
    set(t, e, n) {
        ...
        const s = Pr("Transaction.set", t, this.t_);
        n = Ir("Transaction.set", n);
        const i = yr(s.Kc, e, n), r = Oi(this.t_.jl, "Transaction.set", s.Gc, i, null !== s.Kc, n);
        return this.e_.set(s.Gc, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof Ii ? (Js("Transaction.update", arguments, 3), 
        i = Pr("Transaction.update", t, this.t_), r = Mi(this.t_.jl, "Transaction.update", i.Gc, e, n, s)) : (Xs("Transaction.update", arguments, 2), 
        i = Pr("Transaction.update", t, this.t_), r = qi(this.t_.jl, "Transaction.update", i.Gc, e)), 
        this.e_.update(i.Gc, r), this;
    }
    delete(t) {
        Xs("Transaction.delete", arguments, 1);
        const e = Pr("Transaction.delete", t, this.t_);
...
class rr {
    ...
    set(t, e, n) {
        Zs("WriteBatch.set", arguments, 2, 3), this.i_();
        const s = Pr("WriteBatch.set", t, this.t_);
        n = Ir("WriteBatch.set", n);
        const i = yr(s.Kc, e, n), r = Oi(this.t_.jl, "WriteBatch.set", s.Gc, i, null !== s.Kc, n);
        return this.n_ = this.n_.concat(r.zc(s.Gc, Ue.je())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.i_(), "string" == typeof e || e instanceof Ii ? (Js("WriteBatch.update", arguments, 3), 
        i = Pr("WriteBatch.update", t, this.t_), r = Mi(this.t_.jl, "WriteBatch.update", i.Gc, e, n, s)) : (Xs("WriteBatch.update", arguments, 2), 
        i = Pr("WriteBatch.update", t, this.t_), r = qi(this.t_.jl, "WriteBatch.update", i.Gc, e)), 
        this.n_ = this.n_.concat(r.zc(i.Gc, Ue.exists(!0))), this;
    }
    delete(t) {
        Xs("WriteBatch.delete", arguments, 1), this.i_();
        const e = Pr("WriteBatch.delete", t, this.t_);
        return this.n_ = this.n_.concat(new en(e.Gc, Ue.je())), this;
    }
    commit() {
        return this.i_(), this.s_ = !0, this.n_.length > 0 ? this.t_.ql().write(this.n_) : Promise.resolve();
    }
    i_() {
        if (this.s_) throw new x(k.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class or extends Fi {
    constructor(t, e, n) {
        super(e.jc, t, n), this.Gc = t, this.firestore = e, this.Kc = n, this.Ml = this.firestore.ql();
    }
    static Jl(t, e, n) {
    ...
    set(t, e) {
        ...
        const n = yr(this.Kc, t, e), s = Oi(this.firestore.jl, "DocumentReference.set", this.Gc, n, null !== this.Kc, e);
        return this.Ml.write(s.zc(this.Gc, Ue.je()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof Ii ? (Js("DocumentReference.update", arguments, 2), 
        s = Mi(this.firestore.jl, "DocumentReference.update", this.Gc, t, e, n)) : (Xs("DocumentReference.update", arguments, 1), 
        s = qi(this.firestore.jl, "DocumentReference.update", this.Gc, t)), this.Ml.write(s.zc(this.Gc, Ue.exists(!0)));
    }
    delete() {
        return Xs("DocumentReference.delete", arguments, 0), this.Ml.write([ new en(this.Gc, Ue.je()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        return this.Ml.listen(fn(this.Gc.path), o, h);
    }
    get(t) {
        Zs("DocumentReference.get", arguments, 0, 1), Ar("DocumentReference.get", t);
        const e = this.firestore.ql();
        return t && "cache" === t.source ? e.Al(this.Gc).then(t => new ar(this.firestore, this.Gc, t, 
        /*fromCache=*/ !0, t instanceof an && t.Ge, this.Kc)) : e.Pl(this.Gc, t).then(t => this.r_(t));
    }
    withConverter(t) {
...
class ar {
    constructor(t, e, n, s, i, r) {
        this.t_ = t, this.Gc = e, this.o_ = n, this.h_ = s, this.a_ = i, this.Kc = r;
    }
    data(t) {
        ...
        this.o_) {
            ...
            if (this.Kc) {
                const e = new ur(this.t_, this.Gc, this.o_, this.h_, this.a_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(e, t);
            }
            return new tr(this.t_.jc, this.t_.Zl(), t.serverTimestamps || "none", t => new or(t, this.t_, /* converter= */ null)).bl(this.o_.Ze());
        }
    }
    get(t, e) {
        if (Zs("DocumentSnapshot.get", arguments, 1, 2), e = Rr("DocumentSnapshot.get", e), 
        this.o_) {
            const n = this.o_.data().field(Gi("DocumentSnapshot.get", t, this.Gc));
            if (null !== n) {
                return new tr(this.t_.jc, this.t_.Zl(), e.serverTimestamps || "none", t => new or(t, this.t_, this.Kc)).bl(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new or(this.Gc, this.t_, this.Kc);
    }
    get exists() {
        return null !== this.o_;
    }
    get metadata() {
        return new hr(this.a_, this.h_);
    }
    isEqual(t) {
        if (!(t instanceof ar)) throw _i("isEqual", "DocumentSnapshot", 1, t);
        return this.t_ === t.t_ && this.h_ === t.h_ && this.Gc.isEqual(t.Gc) && (null === this.o_ ? null === t.o_ : this.o_.isEqual(t.o_)) && this.Kc === t.Kc;
    }
}
...
class Tr {
    ...
    where(t, e, n) {
        ...
        const i = Gi("Query.where", t), r = cr(this.u_, "Query.where", this.firestore.jl, this.firestore.jc, i, s, n);
        return new Tr(function(t, e) {
            const n = t.filters.concat([ e ]);
            return new _n(t.path, t.collectionGroup, t.tn.slice(), n, t.limit, t.en, t.startAt, t.endAt);
        }(this.u_, r), this.firestore, this.Kc);
    }
    orderBy(t, e) {
        let n;
        ...
        const s = Gi("Query.orderBy", t), i = lr(this.u_, s, n);
        return new Tr(function(t, e) {
        ...
        }(this.u_, i), this.firestore, this.Kc);
    }
    limit(t) {
        return Xs("Query.limit", arguments, 1), ti("Query.limit", "number", 1, t), fi("Query.limit", 1, t), 
        new Tr(mn(this.u_, t, "F" /* First */), this.firestore, this.Kc);
    }
    limitToLast(t) {
        return Xs("Query.limitToLast", arguments, 1), ti("Query.limitToLast", "number", 1, t), 
        fi("Query.limitToLast", 1, t), new Tr(mn(this.u_, t, "L" /* Last */), this.firestore, this.Kc);
    }
    startAt(t, ...e) {
        Js("Query.startAt", arguments, 1);
        const n = this.c_("Query.startAt", t, e, 
        /*before=*/ !0);
        return new Tr(En(this.u_, n), this.firestore, this.Kc);
    }
    startAfter(t, ...e) {
        Js("Query.startAfter", arguments, 1);
        const n = this.c_("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new Tr(En(this.u_, n), this.firestore, this.Kc);
    }
    endBefore(t, ...e) {
        Js("Query.endBefore", arguments, 1);
        const n = this.c_("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new Tr(In(this.u_, n), this.firestore, this.Kc);
    }
    endAt(t, ...e) {
        Js("Query.endAt", arguments, 1);
        const n = this.c_("Query.endAt", t, e, 
        /*before=*/ !1);
        return new Tr(In(this.u_, n), this.firestore, this.Kc);
    }
    isEqual(t) {
        if (!(t instanceof Tr)) throw _i("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && Rn(this.u_, t.u_) && this.Kc === t.Kc;
    }
    withConverter(t) {
        return new Tr(this.u_, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    c_(t, e, n, s) {
 ...
 */ (this.u_, this.firestore.jc, t, e.o_, s);
        {
            const i = [ e ].concat(n);
            return function(t, e, n, s, i, r) {
                ...
                return new kn(h, r);
            }(this.u_, this.firestore.jc, this.firestore.jl, t, i, s);
        }
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        const o = {
            next: e => {
                t[r] && t[r](new mr(this.firestore, this.u_, e, this.Kc));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
        wr(this.u_);
        return this.firestore.ql().listen(this.u_, i, o);
    }
    get(t) {
        Zs("Query.get", arguments, 0, 1), Ar("Query.get", t), wr(this.u_);
        const e = this.firestore.ql();
        return (t && "cache" === t.source ? e.Vl(this.u_) : e.yl(this.u_, t)).then(t => new mr(this.firestore, this.u_, t, this.Kc));
    }
}

class mr {
    constructor(t, e, n, s) {
        this.t_ = t, this.l_ = e, this.__ = n, this.Kc = s, this.f_ = null, this.d_ = null, 
    ...
    forEach(t, e) {
        ...
        this.__.docs.forEach(n => {
            t.call(e, this.w_(n, this.metadata.fromCache, this.__.qt.has(n.key)));
        });
    }
    get query() {
        return new Tr(this.l_, this.t_, this.Kc);
    }
    docChanges(t) {
        ...
        if (e && this.__.Ut) throw new x(k.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        ...
        return this.t_ === t.t_ && Rn(this.l_, t.l_) && this.__.isEqual(t.__) && this.Kc === t.Kc;
    }
    w_(t, e, n) {
        return new ur(this.t_, t.key, t, e, n, this.Kc);
    }
}

class Er extends Tr {
    constructor(t, e, n) {
        if (super(fn(t), e, n), this.T_ = t, t.length % 2 != 1) throw new x(k.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t.N()} has ${t.length}`);
    }
    get id() {
        return this.u_.path.S();
    }
    get parent() {
        const t = this.u_.path.g();
    ...
    doc(t) {
        ...
        const e = M.$(t);
        return or.Jl(this.u_.path.child(e), this.firestore, this.Kc);
    }
    add(t) {
    ...
    withConverter(t) {
        return new Er(this.T_, this.firestore, t);
    }
}
...
function gr(t) {
    ...
    }(t, (t, e) => new sr(t, e, new Gs, new Ks)), t.registerVersion("@firebase/firestore", "1.16.4", "rn");
}
