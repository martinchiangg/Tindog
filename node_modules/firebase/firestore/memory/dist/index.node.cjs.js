...
function E$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.DEBUG) {
        var i = e.map(A$1);
        w$1.debug.apply(w$1, __spreadArrays([ "Firestore (7.18.0): " + t ], i));
    }
}
...
function I$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.ERROR) {
        var i = e.map(A$1);
        w$1.error.apply(w$1, __spreadArrays([ "Firestore (7.18.0): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.WARN) {
        var i = e.map(A$1);
        w$1.warn.apply(w$1, __spreadArrays([ "Firestore (7.18.0): " + t ], i));
    }
}
 ...
 */ var q$1 = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new G$1(C$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new G$1(C$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new G$1(C$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new G$1(C$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.$ = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(F$1), z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, W$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.V = function(t, e, r) {
    ...
    n.M = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new G$1(C$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new G$1(C$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new G$1(C$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
}(F$1), Q$1 = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
...
function X$1(t) {
    ...
    if (null === e.G) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            ...
            var e;
        })).join(","), K$1(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
        n += On(e.startAt)), e.endAt && (n += "|ub:", n += On(e.endAt)), e.G = n;
    }
    return e.G;
}
 ...
 */ function st(t) {
    ...
    return I$1("GRPC error has no .code"), C$1.UNKNOWN;
    switch (t) {
      case et.OK:
        return C$1.OK;
...
var mt = new ut(Q$1.P), gt = new ht(Q$1.P);
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.Ne = function(t) {
        ...
        return this.Ie = pt(), this.Re = Vt(), this.Ae = new ht(O$1), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Re.get(t);
        return e || (e = new ht(O$1), this.Re = this.Re.nt(t, e)), e;
    }, 
    /**
...
/** Extracts the backend's type order for the provided value. */ function qt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? St(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : T$1();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Ct(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return R$1(t.arrayValue.values || [], e.arrayValue.values || [], Ct);
...
function xt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = O$1(zt(t.latitude), zt(e.latitude));
            return 0 !== n ? n : O$1(zt(t.longitude), zt(e.longitude));
...
function he(t, e) {
    ...
    new Q$1((_((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
 ...
 */ function Ie(t, e, n) {
    ...
    }(n, e) : t instanceof _e ? ke(t, e) : t instanceof De ? Pe(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Ae(t, e), r = Re(n) + Re(t.Me);
        return Kt(n) && Kt(t.Me) ? ee(r) : ne(t.serializer, r);
    }(t, e);
}
 ...
 */ function Ne(t, e, n) {
    ...
    // applications.
    return t instanceof _e ? ke(t, e) : t instanceof De ? Pe(t, e) : n;
}
 ...
 */ function Ae(t, e) {
    return t instanceof Oe ? Kt(n = e) || function(t) {
 ...
 */ function Ge(t, e, n) {
    return t instanceof ze ? function(t, e, n) {
        ...
        if (_(null != n.transformResults), !qe(t.Be, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */ function xe(t, e, n, r) {
    return t instanceof ze ? function(t, e) {
        ...
        return qe(t.Be, e) ? new rn(t.key, j.min()) : e;
    }(t, e);
}
...
function Fe(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || R$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof De && e instanceof De ? R$1(t.elements, e.elements, Ct) : t instanceof Oe && e instanceof Oe ? Ct(t.Me, e.Me) : t instanceof Te && e instanceof Te;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new G$1(C$1.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new G$1(C$1.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ var un = /** @class */ function() {
     ...
     */    return t.prototype.rn = function(e) {
        ...
        return !K$1(this.limit) && "F" /* First */ === this.en;
    }, t.prototype.an = function() {
        return !K$1(this.limit) && "L" /* Last */ === this.en;
 ...
 */ function hn(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new Ln(n)), e.nn.push(new Ln(W$1.q(), "asc" /* ASCENDING */)); else {
 ...
 */ function fn(t) {
    var e = sn(t, un);
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = Y$1(e.path, e.collectionGroup, hn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = hn(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new Ln(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Pn(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new Pn(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.sn = Y$1(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.sn;
}
...
function mn(t) {
    return "Query(target=" + function(t) {
        ...
        K$1(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
...
/** Returns whether `doc` matches the constraints of `query`. */ function gn(t, e) {
    return function(t, e) {
        ...
        return !(t.startAt && !Rn(t.startAt, hn(t), e)) && (!t.endAt || !Rn(t.endAt, hn(t), e));
    }(t, e);
}
...
var bn = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if ($t(r)) {
            ...
            throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Yt(r)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Tn(t, r) : "in" /* IN */ === e ? new _n(t, r) : "not-in" /* NOT_IN */ === e ? new kn(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Dn(t, r) : new n(t, e, r);
    }, n.fn = function(t, e, n) {
        return "in" /* IN */ === e ? new In(t, n) : new Nn(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.dn(xt(e, this.value)) : null !== e && qt(this.value) === qt(e) && this.dn(xt(e, this.value));
...
/** A Filter that implements the array-contains operator. */ var Tn = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Ht(e) && Gt(e.arrayValue, this.value);
    }, n;
...
/** A Filter that implements the IN operator. */ function On(t) {
 ...
 */ function Rn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? Q$1.P(Q$1.U(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
 ...
 */ var Mn = /** @class */ function() {
    ...
    t.prototype.En = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = xe(i, e, e, this.wn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = xe(a, e, o, this.wn));
        }
        return e;
    }, 
    /**
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.pn && T$1(), this.pn = !0, this.yn ? this.error ? this.gn(n, this.error) : this.vn(e, this.result) : new t((function(t, i) {
            r.Pn = function(n) {
                r.vn(e, n).next(t, i);
            }, r.Vn = function(e) {
                r.gn(n, e).next(t, i);
 ...
 */
        ...
        return this.kn(t, new Q$1(e)).next((function(t) {
            var e = vt();
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Hn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = xe(a, h, h, o.wn);
...
/** The result of applying a mutation batch to the backend. */ jn.ss = -1;
...
var Fn = function() {
    ...
    t.prototype.ds = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.cs + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */ var Qn = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.ys && (this.clearTimeout(), this.Ps.reject(new G$1(C$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.ks = function() {
            var e = Wn();
            e && E$1("AsyncQueue", "Visibility state changed to  ", e.visibilityState), t.$s.ms();
        };
        var e = Wn();
    ...
    t.prototype.Us = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Os(), this.Ss ? [ 3 /*break*/ , 2 ] : (this.Ss = !0, (e = Wn()) && "function" == typeof e.removeEventListener && e.removeEventListener("visibilitychange", this.ks), 
                    [ 4 /*yield*/ , this.Ms(t) ]);
    ...
    t.prototype.enqueue = function(t) {
        return this.Os(), this.Ss ? new Promise((function(t) {})) : this.qs(t);
    }, 
    /**
    ...
    t.prototype.Ws = function() {
        ...
        var e = this, n = this.vs.then((function() {
            return e.Fs = !0, t().catch((function(t) {
                ...
                throw e.Ds = t, e.Fs = !1, I$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function Hn(t, e) {
    if (I$1("AsyncQueue", e + ": " + t), zn(t)) return new G$1(C$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
$n.ni = -1, $n.si = 1048576, $n.ii = 41943040, $n.ti = 10, $n.ei = 1e3, $n.ri = new $n($n.ii, $n.ti, $n.ei), 
$n.oi = new $n($n.ni, 0, 0);
...
var Yn = /** @class */ function() {
    ...
    return t.prototype.ai = function(t, e) {
        return this.hi.add(e), Cn.resolve();
    }, t.prototype.Kn = function(t, e) {
        return Cn.resolve(this.hi.getEntries(e));
    }, t;
}(), Xn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.wi = j.min(), this.Nn = t.Ti(n), this.mi = t.Ei(), this.Ii = t.Ri(), this.Ai = new Gn(this.mi, this.Nn, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
    return t.prototype.yi = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Nn, r = this.Ai, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Nn.pi(n).next((function(s) {
                            return i = s, e = o.persistence.Ti(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Gn(o.mi, e, o.persistence.Pi()), e.pi(n);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Nn = e, this.Ai = r, this._i.Vi(this.Ai), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(n) {
            var r = t.batch.keys(), i = e.mi.Ni({
                $i: !0
            });
            return e.ki(n, t, i).next((function() {
                return i.apply(n);
            })).next((function() {
                return e.Nn.xi(n);
            })).next((function() {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            var r;
            return e.Nn.Oi(n, t).next((function(t) {
                return _(null !== t), r = t.keys(), e.Nn.qi(n, t);
            })).next((function() {
                return e.Nn.xi(n);
            })).next((function() {
                return e.Ai.Mn(n, r);
    ...
    }, t.prototype.Bi = function(e) {
        var n = this, r = e.J, i = this.fi;
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            e.Wt.forEach((function(e, s) {
                ...
                if (a) {
                    ...
                    u.push(n.Ii.Wi(o, e.Jt, s).next((function() {
                        return n.Ii.Qi(o, e.Yt, s);
                    })));
                    var c = e.resumeToken;
                    // Update the resume token if the change includes one.
                                        if (c.H() > 0) {
                        var h = a.tt(c, r).Z(o.ji);
                        i = i.nt(s, h), 
                        // Update the target data if there are target changes (or if
                        // sufficient time has passed since the last update).
                        t.Gi(a, h, e) && u.push(n.Ii.Ki(o, h));
                    }
                }
            }));
            var a = pt(), c = wt();
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.jt.forEach((function(i, c) {
                    ...
                    // access.
                    s.zi(i, r), a = a.nt(i, c)) : null == h || c.version.o(h.version) > 0 || 0 === c.version.o(h.version) && h.hasPendingWrites ? (s.Hi(c, r), 
                    a = a.nt(i, c)) : E$1("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", h.version, " Watch version:", c.version), 
                    e.Gt.has(i) && u.push(n.persistence.Xi.Yi(o, i));
                }));
            }))), !r.isEqual(j.min())) {
                var h = n.Ii.Ui(o).next((function(t) {
                    return n.Ii.Ji(o, o.ji, r);
                }));
                u.push(h);
            }
            return Cn.Cn(u).next((function() {
                return s.apply(o);
            })).next((function() {
                return n.Ai.Un(o, a);
            }));
    ...
    t.Gi = function(t, e, n) {
        ...
        // closing.
        e.J.I() - t.J.I() >= this.Zi || n.Yt.size + n.Xt.size + n.Jt.size > 0);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Cn.forEach(t, (function(t) {
                            return Cn.forEach(t.Yn, (function(n) {
                                return h.persistence.Xi.er(e, t.targetId, n);
                            })).next((function() {
                                return Cn.forEach(t.Xn, (function(n) {
                                    return h.persistence.Xi.nr(e, t.targetId, n);
                                }));
                            }));
                        }));
                    })) ];
                  ...
                  case 3:
                    for (r = 0, i = t; r < i.length; r++) o = i[r], s = o.targetId, o.fromCache || (u = this.fi.get(s), 
                    a = u.J, c = u.et(a), 
                    // Advance the last limbo free snapshot version
                    this.fi = this.fi.nt(s, c));
                    return [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Get next mutation batch", "readonly", (function(n) {
            return void 0 === t && (t = -1), e.Nn.ir(n, t);
        }));
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            var r;
            return e.Ii.hr(n, t).next((function(i) {
                return i ? (
                // This target has been listened to previously, so reuse the
                // previous targetID.
                // TODO(mcg): freshen last accessed date?
                r = i, Cn.resolve(r)) : e.Ii.ar(n).next((function(i) {
                    return r = new rt(t, i, 0 /* Listen */ , n.ji), e.Ii.ur(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
            ...
            // the in-memory data
            var r = e.fi.get(n.targetId);
            return (null === r || n.J.o(r.J) > 0) && (e.fi = e.fi.nt(n.targetId, n), e.di.set(t, n.targetId)), 
            n;
        }));
    }, t.prototype.hr = function(t, e) {
        var n = this.di.get(e);
        return void 0 !== n ? Cn.resolve(this.fi.get(n)) : this.Ii.hr(t, e);
    }, t.prototype.cr = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o, s = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    e = this.fi.get(t), i = r ? "readwrite" : "readwrite-primary", n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 5 ]), r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.persistence.runTransaction("Release target", i, (function(t) {
                        return s.persistence.Xi.removeTarget(t, e);
                    })) ];
                  ...
                  case 5:
                    return this.fi = this.fi.remove(t), this.di.delete(e.target), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.hr(o, fn(t)).next((function(t) {
                if (t) return r = t.lastLimboFreeSnapshotVersion, n.Ii._r(o, t.targetId).next((function(t) {
                    i = t;
                }));
            })).next((function() {
                return n._i.Wn(o, t, e ? r : j.min(), e ? i : wt());
            })).next((function(t) {
                return {
                    documents: t,
                    dr: i
...
function tr(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            if (t.code !== C$1.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
...
var er = /** @class */ function() {
    function t() {
        ...
        this.mr = new ht(nr.Er), 
        // A set of outstanding references to a document sorted by target id.
        this.Ir = new ht(nr.Rr)
        /** Returns true if the reference set contains no references. */;
    }
    return t.prototype._ = function() {
        return this.mr._();
    }, 
    /** Adds a reference to the given document key for the given ID. */ t.prototype.er = function(t, e) {
        var n = new nr(t, e);
        this.mr = this.mr.add(n), this.Ir = this.Ir.add(n);
    }, 
    ...
    t.prototype.yr = function(t) {
        var e = this, n = new Q$1(new B([])), r = new nr(n, t), i = new nr(n, t + 1), o = [];
        return this.Ir.bt([ r, i ], (function(t) {
            e.Pr(t), o.push(t.key);
        })), o;
        ...
        this.mr = this.mr.delete(t), this.Ir = this.Ir.delete(t);
    }, t.prototype.gr = function(t) {
        var e = new Q$1(new B([])), n = new nr(e, t), r = new nr(e, t + 1), i = wt();
        return this.Ir.bt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.vr = function(t) {
        var e = new nr(t, 0), n = this.mr.Ct(e);
    ...
    return t.Er = function(t, e) {
        return Q$1.P(t.key, e.key) || O$1(t.br, e.br);
    }, 
    /** Compare by ID then by key */ t.Rr = function(t, e) {
        return O$1(t.br, e.br) || Q$1.P(t.key, e.key);
    }, t;
}(), rr = /** @class */ function() {
    function t(t) {
        this.uid = t;
    ...
    t.prototype.Cr = function() {
        return this.Sr() ? "uid:" + this.uid : "anonymous-user";
    }, t.prototype.isEqual = function(t) {
...
rr.Dr = new rr("google-credentials-uid"), rr.Fr = new rr("first-party-uid");
 ...
 */
var ir = function(t, e) {
    this.user = e, this.type = "OAuth", this.Nr = {}, 
    // Set the headers using Object Literal notation to avoid minification
    this.Nr.Authorization = "Bearer " + t;
}, or = /** @class */ function() {
    function t() {
        /**
    ...
    }, t.prototype.kr = function() {}, t.prototype.xr = function(t) {
        this.$r = t, 
    ...
    function t(t) {
        ...
        this.currentUser = rr.UNAUTHENTICATED, this.qr = !1, 
        /**
        ...
        this.$r = null, this.forceRefresh = !1, this.Or = function() {
            e.Mr++, e.currentUser = e.Ur(), e.qr = !0, e.$r && e.$r(e.currentUser);
        }, this.Mr = 0, this.auth = t.getImmediate({
            optional: !0
        }), this.auth ? this.auth.addAuthTokenListener(this.Or) : (
        // if auth is not available, invoke tokenListener once with null token
        this.Or(null), t.get().then((function(t) {
            e.auth = t, e.Or && 
            // tokenListener can be removed by removeChangeListener()
            e.auth.addAuthTokenListener(e.Or);
        }), (function() {})));
    }
    return t.prototype.getToken = function() {
        ...
        this.qr && t(this.currentUser);
    }, t.prototype.Lr = function() {
        this.auth && this.auth.removeAuthTokenListener(this.Or), this.Or = null, this.$r = null;
    }, 
    ...
    function t(t, e) {
        this.Br = t, this.Wr = e, this.type = "FirstParty", this.user = rr.Fr;
    }
    return Object.defineProperty(t.prototype, "Nr", {
        get: function() {
            var t = {
                "X-Goog-AuthUser": this.Wr
            }, e = this.Br.auth.Qr([]);
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new ur(this.Br, this.Wr));
    }, t.prototype.xr = function(t) {
        // Fire with initial uid.
        t(rr.Fr);
    }, t.prototype.Lr = function() {}, t.prototype.kr = function() {}, t;
}(), cr = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.rs = t, this.jr = n, this.Gr = r, this.Kr = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.zr = 0, this.Hr = null, this.stream = null, this.$s = new Bn(t, e)
        /**
    ...
    t.prototype.start = function() {
        3 /* Error */ !== this.state ? this.auth() : this.Jr();
    }, 
    /**
    ...
    t.prototype.stop = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Yr() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.to = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.Xr() && null === this.Hr && (this.Hr = this.rs.Ts(this.jr, 6e4, (function() {
            return t.eo();
        })));
    }, 
    /** Sends a message to the underlying stream. */ t.prototype.no = function(t) {
        this.so(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.eo = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.Xr() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype.so = function() {
        this.Hr && (this.Hr.cancel(), this.Hr = null);
    }, 
    /**
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.so(), this.$s.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.zr++, 3 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.$s.reset() : r && r.code === C$1.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    I$1(r.toString()), I$1("Using maximum backoff delay to prevent overloading the backend."), 
                    this.$s.fs()) : r && r.code === C$1.UNAUTHENTICATED && 
                    // "unauthenticated" error means the token was rejected. Try force refreshing it in case it
                    // just expired.
                    this.Kr.kr(), 
                    // Clean up the underlying stream because we are no longer interested in events.
                    null !== this.stream && (this.io(), this.stream.close(), this.stream = null), 
                    // This state must be assigned before calling onClose() to allow the callback to
                    // inhibit backoff or otherwise manipulate the state in its non-started state.
                    this.state = t, [ 4 /*yield*/ , this.listener.ro(r) ];
     ...
     */
    t.prototype.io = function() {}, t.prototype.auth = function() {
        var t = this;
        this.state = 1 /* Starting */;
        var e = this.oo(this.zr), n = this.zr;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.Kr.getToken().then((function(e) {
            ...
            e((function() {
                var e = new G$1(C$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ao(e);
            }));
        }));
    }, t.prototype.ho = function(t) {
        var e = this, n = this.oo(this.zr);
        this.stream = this.uo(t), this.stream.co((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.listener.co();
            }));
        })), this.stream.ro((function(t) {
            n((function() {
                return e.ao(t);
            }));
    ...
    return __extends(n, e), n.prototype.uo = function(t) {
        return this.Gr.lo("Listen", t);
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? C$1.UNKNOWN : st(t.code);
                ...
                y.document;
                var v = he(t, y.document), m = y.readTime ? ue(y.readTime) : j.min(), g = new rn(v, m), w = y.removedTargetIds || [];
                n = new kt([], w, g.key, g);
                ...
                var N = e.filter;
                N.targetId;
                var A = N.count || 0, k = new it(A), D = N.targetId;
                n = new Dt(D, k);
            }
            return n;
    ...
    n.prototype.fo = function(t) {
        ...
        n && (e.labels = n), this.no(e);
    }, 
    /**
     * Unregisters interest in the results of the target associated with the
     * given targetId.
     */
    n.prototype.do = function(t) {
        var e = {};
        e.database = le(this.serializer), e.removeTarget = t, this.no(e);
    }, n;
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "To", {
        /**
    ...
    n.prototype.start = function() {
        ...
        return this.Gr.lo("Write", t);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        _(!!t.streamToken), this.lastStreamToken = t.streamToken, this.wo) {
        ...
        // The first response is always the handshake response
                return _(!t.writeResults || 0 === t.writeResults.length), this.wo = !0, 
        this.listener.Io();
    }, 
    /**
    ...
    n.prototype.Ro = function() {
        ...
        var t = {};
        t.database = le(this.serializer), this.no(t);
    }, 
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.mo = function(t) {
        var e = this, n = {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).credentials = t, i.Gr = n, i.serializer = r, i.Ao = !1, 
        i;
    }
    return __extends(n, e), n.prototype.Po = function() {
        if (this.Ao) throw new G$1(C$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Vo = function(t, e, n) {
        var r = this;
        return this.Po(), this.credentials.getToken().then((function(i) {
            return r.Gr.Vo(t, e, n, i);
        })).catch((function(t) {
            throw t.code === C$1.UNAUTHENTICATED && r.credentials.kr(), t;
        }));
    }, 
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.yo = function(t, e, n) {
        var r = this;
        return this.Po(), this.credentials.getToken().then((function(i) {
            return r.Gr.yo(t, e, n, i);
        })).catch((function(t) {
            throw t.code === C$1.UNAUTHENTICATED && r.credentials.kr(), t;
        }));
    ...
    return t.prototype.Co = function() {
        var t = this;
        0 === this.vo && (this.Do("Unknown" /* Unknown */), this.bo = this.Is.Ts("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
    ...
    t.prototype.set = function(t) {
        ...
        t !== this.state && (this.state = t, this.po(t));
    ...
    r, i, o, s) {
        ...
        this.Go = function(t, e, n) {
            var r = k$1(t);
            return r.Po(), new hr(e, r.Gr, r.credentials, r.serializer, n);
        }(this.xo, i, {
            co: this.Ko.bind(this),
            ro: this.zo.bind(this),
            _o: this.Ho.bind(this)
        }), this.Yo = function(t, e, n) {
            var r = k$1(t);
            return r.Po(), new fr(e, r.Gr, r.credentials, r.serializer, n);
        }(this.xo, i, {
            co: this.Xo.bind(this),
            ro: this.Jo.bind(this),
            Io: this.Zo.bind(this),
    ...
    t.prototype.ah = function(t) {
        this.Oo.delete(t), this.Go.Xr() && this.uh(t), 0 === this.Oo.size && (this.Go.Xr() ? this.Go.to() : this.Wo() && 
    ...
    t.prototype.hh = function(t) {
        this.qo.de(t.targetId), this.Go.fo(t);
    }, 
    /**
    ...
    t.prototype.uh = function(t) {
        this.qo.de(t), this.Go.do(t);
    }, t.prototype.nh = function() {
        this.qo = new Rt(this), this.Go.start(), this.jo.Co();
    }, 
    /**
    ...
    t.prototype.eh = function() {
        return this.Wo() && !this.Go.Yr() && this.Oo.size > 0;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.jo.set("Online" /* Online */), !(t instanceof Pt && 2 /* Removed */ === t.state && t.cause)) 
                  ...
                  case 6:
                    if (t instanceof kt ? this.qo.Pe(t) : t instanceof Dt ? this.qo.Ce(t) : this.qo.pe(t), 
                    r.isEqual(j.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.ko.Ui() ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , this.ko.sr(t) ];

                  case 3:
                    return null === (e = n.sent()) ? (0 === this.Lo.length && this.Yo.to(), [ 3 /*break*/ , 7 ]) : (t = e.batchId, 
                    this.Eh(e), [ 3 /*break*/ , 6 ]);
    ...
    t.prototype.Eh = function(t) {
        this.Lo.push(t), this.Yo.Xr() && this.Yo.To && this.Yo.mo(t.mutations);
    }, t.prototype.Ih = function() {
        return this.Wo() && !this.Yo.Yr() && this.Lo.length > 0;
    }, t.prototype.Rh = function() {
        this.Yo.start();
    }, t.prototype.Xo = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.Yo.Ro(), [ 2 /*return*/ ];
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                ...
                for (t = 0, e = this.Lo; t < e.length; t++) r = e[t], this.Yo.mo(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Eo = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Lo.shift(), i = qn.from(e, t, r), [ 4 /*yield*/ , this.wh((function() {
                        return o.lh.Ph(i);
                    })) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return t && this.Yo.To ? [ 4 /*yield*/ , this.Vh(t) ] : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== C$1.ABORTED ? (e = this.Lo.shift(), 
                    // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    this.Yo.Zr(), [ 4 /*yield*/ , this.wh((function() {
                        return i.lh.yh(e.batchId, t);
                    })) ]) : [ 3 /*break*/ , 3 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.jo.set("Unknown" /* Unknown */), this.Yo.Zr(), this.Go.Zr(), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.jo.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.lh.ph(t) ];
    ...
    function t() {
        this.Ch = new yr, this.Dh = {}, this.po = null, this.Zn = null;
    }
    return t.prototype.Fh = function(t) {
        ...
        return this.Ch = new yr, Promise.resolve();
    }, t.prototype.yi = function(t, e, n) {
        // No op.
    }, t.prototype.Uh = function(t) {
        // No op.
    }, t.prototype.oh = function() {}, t.prototype.ns = function(t) {}, t;
}(), mr = function(t) {
    this.key = t;
}, gr = function(t) {
    this.key = t;
    ...
    t.prototype.Zh = function(t) {
        ...
        return e.forEach((function(e) {
            t.Qh.has(e) || n.push(new gr(e));
        })), this.Qh.forEach((function(t) {
            e.has(t) || n.push(new mr(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.ia = function(t) {
        this.Bh = t.dr, this.Qh = wt();
        var e = this.zh(t.documents);
...
n) {
    ...
    r, i, o) {
        ...
        this.ca = null, this.la = new q$1((function(t) {
            return vn(t);
        }), yn), this._a = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.da = new ut(Q$1.P), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.wa = new Map, this.Ta = new er, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ma = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Ea = new Map, this.Ia = Jn.li(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return [ 4 /*yield*/ , this.ko.or(fn(t)) ];
    ...
    t.prototype.Va = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.ko.lr(t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new wr(t, e.dr), s = o.zh(e.documents), u = _t.zt(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Jh(s, 
                    /* updateLimboDocuments= */ this.Aa, u), this.ya(r, a.ea), c = new br(t, r, o), 
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.aa.xh(e.targetId), this.aa.Mh(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.ko.cr(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.aa.Oh(e.targetId), i.ha.ah(e.targetId), i.pa(e.targetId);
                    })).catch(tr) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.pa(e.targetId), [ 4 /*yield*/ , this.ko.cr(e.targetId, 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.ko.Si(t) ];

                  case 2:
                    return e = n.sent(), this.aa.Fh(e.batchId), this.ga(e.batchId, r), [ 4 /*yield*/ , this.va(e.Di) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Bi(t) ];
        ...
        if (this.Aa && 0 /* RemoteStore */ === e || !this.Aa && 1 /* SharedClientState */ === e) {
            ...
            })), this.ca.ba(t), this.ca._o(n), this.onlineState = t, this.Aa && this.aa.Uh(t);
        }
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", r), e = this.wa.get(t), (i = e && e.key) ? (o = (o = new ut(Q$1.P)).nt(i, new rn(i, j.min())), 
                    s = wt().add(i), u = new Tt(j.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ht(O$1), o, s), [ 4 /*yield*/ , this.Bi(u) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , this.ko.cr(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.pa(t, r);
                    })).catch(tr) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Fi(t) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.ko.Li(t) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.ko.Mi() ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Na = function(t) {
        this.Ea.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new G$1(C$1.CANCELLED, t));
            }));
        })), this.Ea.clear();
    }, t.prototype.ga = function(t, e) {
        var n = this.ma[this.currentUser.Cr()];
        n || (n = new ut(O$1)), n = n.nt(t, e), this.ma[this.currentUser.Cr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            var r = n.get(t);
            r && (e ? r.reject(e) : r.resolve(), n = n.remove(t)), this.ma[this.currentUser.Cr()] = n;
        }
        ...
        this._a.delete(t), this.Aa && this.Ta.yr(t).forEach((function(t) {
            n.Ta.vr(t) || 
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof mr ? (this.Ta.er(i.key, t), this.xa(i)) : i instanceof gr ? (E$1("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.Ta.nr(i.key, t), this.Ta.vr(i.key) || 
            // We removed the last reference for this key
            this.ka(i.key)) : T$1();
        }
    ...
    t.prototype.Sa = function() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new Er(t)), this.da = this.da.nt(t, e), this.ha.listen(new rt(fn(an(t.path)), e, 2 /* LimboResolution */ , jn.ss));
        }
    }, 
    // Visible for testing
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.la.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.zh(t);
                            return e.Xh ? s.ko.lr(u.query, /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                                return u.view.zh(n, e);
                            })) : e;
                  ...
                  case 1:
                    return n.sent(), this.ca._o(e), [ 4 /*yield*/ , this.ko.tr(i) ];
    ...
    }, t.prototype.Pa = function(t) {}, t.prototype.ph = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (E$1("SyncEngine", "User change. New user:", t.Cr()), 
                    [ 4 /*yield*/ , this.ko.yi(t) ]);
                  ...
                  case 1:
                    ...
                    this.aa.yi(t, e.vi, e.bi), [ 4 /*yield*/ , this.va(e.gi) ];
    ...
    function t(t) {
        this.lh = t, this.Ma = new q$1((function(t) {
            return vn(t);
    ...
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.Ma.get(e)) || (r = !0, i = new Nr), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.na = function(t) {
        ...
        t = At.Bt(t.query, t.docs, t.qt, t.fromCache), this.Ka = !0, this.Ga.next(t);
    }, t;
}(), _r = /** @class */ function() {
    function t() {}
    return t.prototype.Vi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.on() || n.isEqual(j.min()) ? this.tu(t, e) : this.Za.Mn(t, r).next((function(o) {
            var u = i.eu(e, o);
            return (e.hn() || e.an()) && i.Xh(e.en, u, r, n) ? i.tu(t, e) : (b() <= LogLevel.DEBUG && E$1("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), mn(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.eu = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof nn && gn(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.Xh = function(t, e, n, r) {
        ...
        return b() <= LogLevel.DEBUG && E$1("IndexFreeQueryEngine", "Using full collection scan to execute query:", mn(e)), 
        this.Za.Wn(t, e, j.min());
    }, t;
}(), kr = /** @class */ function() {
    function t(t, e) {
        this.$n = t, this.Xi = e, 
        ...
        this.su = new ht(nr.Er);
    }
    return t.prototype.iu = function(t) {
        return Cn.resolve(0 === this.Nn.length);
    }, t.prototype.Ci = function(t, e, n, r) {
        var i = this.nu;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.su = this.su.add(new nr(a.key, i)), this.$n.ai(t, a.key.path.g());
        }
        return Cn.resolve(o);
    }, t.prototype.Oi = function(t, e) {
        return Cn.resolve(this.ru(e));
    }, t.prototype.ir = function(t, e) {
        var n = e + 1, r = this.ou(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Cn.resolve(this.Nn.length > i ? this.Nn[i] : null);
    }, t.prototype.Mi = function() {
        return Cn.resolve(0 === this.Nn.length ? -1 : this.nu - 1);
    }, t.prototype.pi = function(t) {
        return Cn.resolve(this.Nn.slice());
        ...
        // because it precedes all other segments in an ordered traversal.
                Q$1.W(i) || (i = i.child(""));
        var o = new nr(new Q$1(i), 0), s = new ht(O$1);
        ...
        // query.
            ...
            // ancestor queries.
            e.length === r && (s = s.add(t.br)), !0);
        }), o), Cn.resolve(this.hu(s));
        ...
        return Cn.forEach(e.mutations, (function(i) {
            ...
            return r = r.delete(o), n.Xi.uu(t, i.key);
        })).next((function() {
            n.su = r;
        }));
        ...
        return this.Nn.length, Cn.resolve();
    }, 
    /**
    ...
    t.prototype.zi = function(t) {
        ...
        for (var r = vt(), i = new Q$1(e.path.child("")), o = this.docs.ut(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.wt(); ) {
            var s = o.dt(), u = s.key, a = s.value, c = a._u, h = a.readTime;
            if (!e.path.C(u.path)) break;
            h.o(n) <= 0 || c instanceof nn && gn(e, c) && (r = r.nt(c.key, c));
        }
        return Cn.resolve(r);
...
Dr.du = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.Jh = function(t) {
        var e = this, n = [];
        return this.Di.forEach((function(r, i) {
            i ? n.push(e.Au.Hi(t, i, e.readTime)) : e.Au.zi(r);
        })), Cn.Cn(n);
    ...
    t.prototype.Hi = function(t, e) {
        this.Eu(), this.readTime = e, this.Di.set(t.key, t);
    }, 
    /**
    ...
    t.prototype.zi = function(t, e) {
        this.Eu(), e && (this.readTime = e), this.Di.set(t, null);
    }, 
    /**
    ...
    t.prototype.On = function(t, e) {
        this.Eu();
        var n = this.Di.get(e);
        return void 0 !== n ? Cn.resolve(n) : this.Iu(t, e);
    }, 
    /**
...
var Pr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.yu = new er, this.targetCount = 0, this.pu = Jn.ci();
    }
    return t.prototype.ge = function(t, e) {
        ...
        return Cn.resolve(this.Vu);
    }, t.prototype.ar = function(t) {
        return this.highestTargetId = this.pu.next(), Cn.resolve(this.highestTargetId);
        ...
        return this.vu(e), this.targetCount += 1, Cn.resolve();
    }, t.prototype.Ki = function(t, e) {
        return this.vu(e), Cn.resolve();
    }, t.prototype.bu = function(t, e) {
        return this.Pu.delete(e.target), this.yu.yr(e.targetId), this.targetCount -= 1, 
        Cn.resolve();
        ...
        return this.yu.Ar(e, n), Cn.resolve();
    }, t.prototype.Wi = function(t, e, n) {
        this.yu.Vr(e, n);
        var r = this.persistence.Xi, i = [];
        return r && e.forEach((function(e) {
            i.push(r.uu(t, e));
        })), Cn.Cn(i);
    }, t.prototype.Cu = function(t, e) {
        return this.yu.yr(e), Cn.resolve();
    }, t.prototype._r = function(t, e) {
        var n = this.yu.gr(e);
        return Cn.resolve(n);
    }, t.prototype.vr = function(t, e) {
        return Cn.resolve(this.yu.vr(e));
    }, t;
}(), Or = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Fu = {}, this.Nu = new jn(0), this.$u = !1, this.$u = !0, this.Xi = t(this), 
        this.Ii = new Pr(this), this.$n = new Yn, this.Fn = new Dr(this.$n, (function(t) {
            return e.Xi.ku(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Fu[t.Cr()];
        return e || (e = new kr(this.$n, this.Xi), this.Fu[t.Cr()] = e), e;
        ...
        var i = new Rr(this.Nu.next());
        return this.Xi.qu(), n(i).next((function(t) {
            return r.Xi.Mu(i).next((function() {
                return t;
            }));
        })).bn().then((function(t) {
            return i.Uu(), t;
        ...
        return Cn.Dn(Object.values(this.Fu).map((function(n) {
            return function() {
                return n.vr(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).ji = t, n;
    }
    /**
    ...
    return t.Ku = function(e) {
        ...
        return this.ju.er(n, e), this.zu.delete(n), Cn.resolve();
    }, t.prototype.nr = function(t, e, n) {
        return this.ju.nr(n, e), this.zu.add(n), Cn.resolve();
    }, t.prototype.uu = function(t, e) {
        return this.zu.add(e), Cn.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.ju.yr(e.targetId).forEach((function(t) {
            return n.zu.add(t);
        }));
        var r = this.persistence.Ri();
        return r._r(t, e.targetId).next((function(t) {
            t.forEach((function(t) {
                return n.zu.add(t);
            }));
        })).next((function() {
        ...
        var e = this, n = this.persistence.Ei().Ni();
        // Remove newly orphaned documents.
                return Cn.forEach(this.zu, (function(r) {
        ...
        var n = this;
        return Cn.Dn([ function() {
            return Cn.resolve(n.ju.vr(e));
        }, function() {
            return n.persistence.Ri().vr(t, e);
        }, function() {
    ...
    return __extends(n, e), n.prototype.uc = function(t, e, n, r) {
            ...
            s.listenOnce(esm_3.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case esm_2.TIMEOUT:
                        E$1("Connection", 'RPC "' + t + '" timed out'), o(new G$1(C$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case esm_2.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            } else o(new G$1(C$1.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new G$1(C$1.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var s = r.createWebChannel(o, i), p = !1, d = !1, y = new Lr({
            Yu: function(t) {
        ...
        return g(esm_4.EventType.OPEN, (function() {
            d || E$1("Connection", "WebChannel transport opened.");
        })), g(esm_4.EventType.CLOSE, (function() {
            d || (d = !0, E$1("Connection", "WebChannel transport closed"), y.nc());
        })), g(esm_4.EventType.ERROR, (function(t) {
            d || (d = !0, N$1("Connection", "WebChannel transport errored:", t), y.nc(new G$1(C$1.UNAVAILABLE, "The operation could not be completed")));
        })), g(esm_4.EventType.MESSAGE, (function(t) {
            var e;
            if (!d) {
                var n = t.data[0];
                _(!!n);
                ...
                if (i) {
                    ...
                    void 0 === u && (u = C$1.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.nc(new G$1(u, a)), s.close();
    ...
    return t.prototype.Vo = function(t, e, n, r) {
        var i = this.hc(t, e);
    ...
    t.prototype.ac = function(t, e) {
        ...
        t["Content-Type"] = "text/plain", e) for (var n in e.Nr) e.Nr.hasOwnProperty(n) && (t[n] = e.Nr[n]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Gr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", xr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        if (t.yc.Vc) throw new G$1(C$1.FAILED_PRECONDITION, Gr);
        return new Or(Vr.Ku);
        ...
        throw new G$1(C$1.FAILED_PRECONDITION, Gr);
    }, t;
}(), jr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ko ? [ 3 /*break*/ , 3 ] : (this.ko = t.ko, this.aa = t.aa, this.xo = this.pc(r), 
                    this.ha = this.gc(r), this.lh = this.vc(r), this.bc = this.Sc(r), this.aa.po = function(t) {
                        return e.lh.na(t, 1 /* SharedClientState */);
        ...
        return new Ar(this.lh);
    }, t.prototype.pc = function(t) {
        var e, n = Cr(t.ic.s), r = (e = t.ic, new Ur(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n) {
            return new lr(t, e, n);
        }(t.credentials, r, n);
    }, t.prototype.gc = function(t) {
        var e = this;
        return new dr(this.ko, this.xo, t.Is, (function(t) {
        ...
        r, i, o, s) {
            ...
            return s && (u.Ra = !0), u;
        }(this.ko, this.ha, this.xo, this.aa, t.Pc, t.ua, !t.yc.Vc || !t.yc.synchronizeTabs);
    }, t.prototype.terminate = function() {
        return this.ha.oh();
    }, t;
}();
 ...
 */ function zr(t, e) {
    if (0 !== e.length) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Wr(t, e, n) {
    if (e.length !== n) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires " + ai(n, "argument") + ", but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Qr(t, e, n) {
    if (e.length < n) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + ai(n, "argument") + ", but was called with " + ai(e.length, "argument") + ".");
}
 ...
 */ function Kr(t, e, n, r) {
    if (e.length < n || e.length > r) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + ai(e.length, "argument") + ".");
}
...
function Jr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = ni(r);
        throw new G$1(C$1.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function Zr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid value " + ni(r) + " provided to function " + t + "() for its " + ui(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function ti(t, e, n, r) {
    if (!("object" === e ? ei(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = ni(r);
        throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ri(t, e, n) {
    if (void 0 === n) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ui(e) + " argument, but it was undefined.");
}
 ...
 */ function ii(t, e, n) {
    U$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new G$1(C$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function oi(t, e, n, r) {
    var i = ni(r);
    return new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + ui(n) + " argument to be a " + e + ", but it was: " + i);
}

function si(t, e, n) {
    if (n <= 0) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + ui(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function ci() {
    if ("undefined" == typeof Uint8Array) throw new G$1(C$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function hi() {
    if ("undefined" == typeof atob) throw new G$1(C$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var fi = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        Wr("Blob.fromBase64String", arguments, 1), Hr("Blob.fromBase64String", "string", 1, e), 
        hi();
        try {
            return new t(tt.fromBase64String(e));
        } catch (e) {
            throw new G$1(C$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new G$1(C$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + ai(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Hr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Nc = new W$1(t);
}, pi = /** @class */ function(e) {
    /**
    ...
    return __extends(n, e), n.prototype.xc = function(t) {
...
var gi = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.xc = function(t) {
        var e = new Oe(t.serializer, re(t.serializer, this.Bc));
    ...
    return __extends(n, e), n.delete = function() {
        ...
        return zr("FieldValue.serverTimestamp", arguments), new Ni(new gi("FieldValue.serverTimestamp"));
        ...
        return Hr("FieldValue.increment", "number", 1, t), Wr("FieldValue.increment", arguments, 1), 
    ...
    function t(t, e) {
        if (Wr("GeoPoint", arguments, 2), Hr("GeoPoint", "number", 1, t), Hr("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new G$1(C$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new G$1(C$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Wc = t, this.Qc = e;
    }
     ...
     */
    t.prototype.T = function(t) {
        return O$1(this.Wc, t.Wc) || O$1(this.Qc, t.Qc);
    }, t;
    ...
    return t.prototype.zc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new We(t, this.data, this.qe, e)) : n.push(new ze(t, this.data, e)), 
...
/** A "context" object passed around while parsing user data. */ var Oi = /** @class */ function() {
    /**
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Hc(), this.fieldTransforms = i || [], this.qe = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Yc = function(e) {
        ...
        return Fi(t, this.settings.methodName, this.settings.el || !1, this.path, this.settings.qc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Pi(this.Lc) && Ti.test(t)) throw this.Oc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ri = /** @class */ function() {
    function t(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || Cr(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.nl = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Oi({
            Lc: t,
            methodName: e,
            qc: n,
            path: W$1.k(),
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function Vi(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.nl(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Gi("Data must be an object, but it was:", s, r);
    var u, a, c = qi(r, s);
    if (o.merge) u = new Le(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(d)) throw new G$1(C$1.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Bi(h, d) || h.push(d);
        }
    ...
    return new ki(new Je(c), u, a);
}

/** Parse update data from an update() call. */ function Li(t, e, n, r) {
    var i = t.nl(1 /* Update */ , e, n);
    Gi("Data must be an object, but it was:", i, r);
    var o = [], s = new Ze;
    U$1(r, (function(t, r) {
        var u = ji(e, t, n), a = i.Zc(u);
...
/** Parse update data from a list of field/value arguments. */ function Si(t, e, n, r, i, o) {
    var s = t.nl(1 /* Update */ , e, n), u = [ xi(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    ...
    var m = new Le(h);
    return new Di(f.Ke(), m, s.fieldTransforms);
}
 ...
 */ function Mi(t, e) {
    if (Ci(t)) return Gi("Unsupported field value:", e, t), qi(t, e);
    if (t instanceof yi) 
    ...
    return function(t, e) {
        ...
        if (!Pi(e.Lc)) throw e.Oc(t.kc + "() can only be used with update() and set()");
    ...
    e.path && e.qe.push(e.path), t instanceof Array) {
        ...
        if (e.settings.Mc && 4 /* ArrayArgument */ !== e.Lc) throw e.Oc("Nested arrays are not supported");
        return function(t, e) {
...
function Ci(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x$1 || t instanceof Ai || t instanceof fi || t instanceof _i || t instanceof yi);
}
 ...
 */ function ji(t, e, n) {
    try {
        return function(t) {
            if (t.search(di) >= 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (pi.bind.apply(pi, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new G$1(C$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Nc;
    } catch (e) {
...
function Fi(t, e, n, r, i) {
    ...
    a += ")"), new G$1(C$1.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var zi = /** @class */ function() {
    ...
    return t.prototype.hl = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.al(), this.mutations.length > 0) throw new G$1(C$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = k$1(t), i = le(e.serializer) + "/documents", o = {
                                        documents: r.map((function(t) {
                                            return ce(e.serializer, t);
                                        }))
                                    }, [ 4 /*yield*/ , e.yo("BatchGetDocuments", i, o) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof rn || t instanceof nn ? i.ul(t) : T$1();
                    })), r) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new G$1(C$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.cl = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new G$1(C$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        this.Is = t, this.xo = e, this.updateFunction = n, this.Ps = r, this.ll = 5, this.$s = new Bn(this.Is, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.$s.ds((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new zi(this.xo), (e = this.fl(t)) && e.then((function(e) {
                        r.Is.gs((function() {
        ...
        try {
            ...
            return !K$1(e) && e.catch && e.then ? e : (this.Ps.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        var e = this;
        this.ll > 0 && this.wl(t) ? (this.ll -= 1, this.Is.gs((function() {
            return e._l(), Promise.resolve();
        }))) : this.Ps.reject(t);
     ...
     */
    e) {
        this.credentials = t, this.Is = e, this.clientId = P$1.t(), 
    ...
    return t.prototype.start = function(t, e, n, r) {
        ...
        return this.credentials.xr((function(t) {
            if (!s) return s = !0, E$1("FirestoreClient", "Initializing. user=", t.uid), i.El(e, n, r, t, o).then(i.Tl.resolve, i.Tl.reject);
            i.Is.Bs((function() {
                return i.ha.ph(t);
            }));
        })), 
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        var t = this;
        return this.ml(), this.Is.enqueue((function() {
     ...
     *     succeeded.
     */
    t.prototype.El = function(t, r, i, o, s) {
        return __awaiter(this, void 0, void 0, (function() {
            var u, a, c = this;
            return __generator(this, (function(h) {
                switch (h.label) {
                  ...
                  case 2:
                    ...
                    this.Ic = t.Ic, this.xo = r.xo, this.ha = r.ha, this.lh = r.lh, this.Il = r.bc, 
    ...
    t.prototype.Rl = function(t) {
        return "FirebaseError" === t.name ? t.code === C$1.FAILED_PRECONDITION || t.code === C$1.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || 
    ...
    t.prototype.ml = function() {
        if (this.Is.xs) throw new G$1(C$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return this.ml(), [ 4 /*yield*/ , this.Tl.promise ];
                                    ...
                                    return o = new Fn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  case 0:
                                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , r.rr(i) ];

                                                  case 1:
                                                    return (t = n.sent()) instanceof nn ? o.resolve(t) : t instanceof rn ? o.resolve(null) : o.reject(new G$1(C$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Fn, o = Ki(t, e, an(n.path), {
                            ...
                            next: function(t) {
                                ...
                                i.reject(new G$1(C$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : e && t.fromCache && r && "server" === r.source ? i.reject(new G$1(C$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                                    ...
                                    return o = new Fn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  case 0:
                                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , r.lr(i, 
                                                    /* usePreviousResults= */ !0) ];

                                                  case 1:
                                                    return t = n.sent(), e = new wr(i, t.dr), s = e.zh(t.documents), u = e.Jh(s, 
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Fn, o = Ki(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new G$1(C$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
        ...
        return this.Is.gs((function() {
            ...
            i.Dc(), r.Is.gs((function() {
                return __awaiter(r, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        return [ 2 /*return*/ , this.Il.ja(i) ];
                    }));
                }));
            }));
        };
    }, Object.defineProperty(t.prototype, "pl", {
        get: function() {
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Fn;
        return this.Is.gs((function() {
            return new Wi(e.Is, e.xo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var Hi = /** @class */ function() {
    function t(t, e, n, r) {
        this.s = t, this.timestampsInSnapshots = e, this.gl = n, this.vl = r;
    }
    return t.prototype.bl = function(t) {
        switch (qt(t)) {
          ...
          case 3 /* TimestampValue */ :
            return this.Sl(t.timestampValue);
          ...
          case 7 /* RefValue */ :
            return this.Dl(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return this.Fl(t.geoPointValue);

          case 9 /* ArrayValue */ :
            return this.Nl(t.arrayValue);

          case 10 /* ObjectValue */ :
            return this.$l(t.mapValue);
        ...
        var e = B.$(t);
        _(be(e));
        var n = new L$1(e.get(1), e.get(3)), r = new Q$1(e.p(5));
...
}(), $i = $n.ni, Yi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new G$1(C$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        Xr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = $n.ii; else {
            if (t.cacheSizeBytes !== $i && t.cacheSizeBytes < $n.si) throw new G$1(C$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + $n.si);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new xr), void 0 === s && (s = new jr), this.kl = o, this.xl = s, 
        this.Ll = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Ol = new Kn, this.INTERNAL = {
            delete: function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ...
                            // throws an exception.
                            return this.ql(), [ 4 /*yield*/ , this.Ml.terminate() ];
            ...
            var a = r;
            this.Ll = a, this.jc = t.Ul(a), this.Bl = a.name, this.Wl = new sr(i);
        } else {
            var c = r;
            if (!c.projectId) throw new G$1(C$1.INVALID_ARGUMENT, "Must provide projectId");
            this.jc = new L$1(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Bl = "[DEFAULT]", this.Wl = new or;
        }
        this.Ql = new Yi({});
    }
    return Object.defineProperty(t.prototype, "jl", {
        get: function() {
            return this.Gl || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.Gl = new Ri(this.jc, this.Ql.ignoreUndefinedProperties)), this.Gl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        Wr("Firestore.settings", arguments, 1), Hr("Firestore.settings", "object", 1, t);
        var e = new Yi(t);
        if (this.Ml && !this.Ql.isEqual(e)) throw new G$1(C$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.Ql = e, void 0 !== e.credentials && (this.Wl = function(t) {
            if (!t) return new or;
            switch (t.type) {
              case "gapi":
                var e = t.Kl;
              ...
              default:
                throw new G$1(C$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        return this.ql(), this.Ml.enableNetwork();
    }, t.prototype.disableNetwork = function() {
        return this.ql(), this.Ml.disableNetwork();
    }, t.prototype.enablePersistence = function(t) {
        var e, n;
        if (this.Ml) throw new G$1(C$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new G$1(C$1.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        return this.zl(this.kl, this.xl, {
            Vc: !0,
            cacheSizeBytes: this.Ql.cacheSizeBytes,
            synchronizeTabs: r,
            Hl: i
        });
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.Ml && !this.Ml.pl) throw new G$1(C$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Fn, [ 2 /*return*/ , (this.Ol.Ls((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e;
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.kl.clearPersistence(this.jc, this.Bl) ];
        ...
        get: function() {
            return this.ql(), this.Ml.pl;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.waitForPendingWrites = function() {
        return this.ql(), this.Ml.waitForPendingWrites();
    }, t.prototype.onSnapshotsInSync = function(t) {
        if (this.ql(), Fr(t)) return this.Ml.Qa(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.zl(new xr, new jr, {
            Vc: !1
        }), this.Ml;
    }, t.prototype.Xl = function() {
        return new V$1(this.jc, this.Bl, this.Ql.host, this.Ql.ssl, this.Ql.forceLongPolling);
    }, t.prototype.zl = function(t, e, n) {
        var r = this.Xl();
        return this.Ml = new Qi(this.Wl, this.Ol), this.Ml.start(r, t, e, n);
    }, t.Ul = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new G$1(C$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new G$1(C$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new L$1(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ll) throw new G$1(C$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ll;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return Wr("Firestore.collection", arguments, 1), Hr("Firestore.collection", "non-empty string", 1, t), 
        this.ql(), new lo(B.$(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return Wr("Firestore.doc", arguments, 1), Hr("Firestore.doc", "non-empty string", 1, t), 
        this.ql(), to.Jl(B.$(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (Wr("Firestore.collectionGroup", arguments, 1), Hr("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        ...
        var e = this;
        return Wr("Firestore.runTransaction", arguments, 1), Hr("Firestore.runTransaction", "function", 1, t), 
    ...
    t.prototype.Zl = function() {
        return this.Ql.timestampsInSnapshots;
    }, t;
}(), Ji = /** @class */ function() {
    function t(t, e) {
        this.t_ = t, this.e_ = e;
    ...
    return t.prototype.get = function(t) {
        ...
        var n = mo("Transaction.get", t, this.t_);
        return this.e_.hl([ n.Gc ]).then((function(t) {
            if (!t || 1 !== t.length) return T$1();
            var r = t[0];
            if (r instanceof rn) return new no(e.t_, n.Gc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            if (r instanceof nn) return new no(e.t_, n.Gc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Kc);
            throw T$1();
        }));
        ...
        var r = mo("Transaction.set", t, this.t_);
        n = po("Transaction.set", n);
        var i = wo(r.Kc, e, n), o = Vi(this.t_.jl, "Transaction.set", r.Gc, i, null !== r.Kc, n);
        return this.e_.set(r.Gc, o), this;
        ...
        r = mo("Transaction.update", t, this.t_), i = Si(this.t_.jl, "Transaction.update", r.Gc, e, n, o)) : (Wr("Transaction.update", arguments, 2), 
        r = mo("Transaction.update", t, this.t_), i = Li(this.t_.jl, "Transaction.update", r.Gc, e)), 
        this.e_.update(r.Gc, i), this;
    }, t.prototype.delete = function(t) {
        Wr("Transaction.delete", arguments, 1);
        var e = mo("Transaction.delete", t, this.t_);
        return this.e_.delete(e.Gc), this;
    }, t;
}(), Zi = /** @class */ function() {
    function t(t) {
        this.t_ = t, this.n_ = [], this.s_ = !1;
    }
    return t.prototype.set = function(t, e, n) {
        Kr("WriteBatch.set", arguments, 2, 3), this.i_();
        var r = mo("WriteBatch.set", t, this.t_);
        n = po("WriteBatch.set", n);
        var i = wo(r.Kc, e, n), o = Vi(this.t_.jl, "WriteBatch.set", r.Gc, i, null !== r.Kc, n);
        return this.n_ = this.n_.concat(o.zc(r.Gc, Me.je())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.i_(), "string" == typeof e || e instanceof pi ? (Qr("WriteBatch.update", arguments, 3), 
        r = mo("WriteBatch.update", t, this.t_), i = Si(this.t_.jl, "WriteBatch.update", r.Gc, e, n, o)) : (Wr("WriteBatch.update", arguments, 2), 
        r = mo("WriteBatch.update", t, this.t_), i = Li(this.t_.jl, "WriteBatch.update", r.Gc, e)), 
        this.n_ = this.n_.concat(i.zc(r.Gc, Me.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        Wr("WriteBatch.delete", arguments, 1), this.i_();
        var e = mo("WriteBatch.delete", t, this.t_);
        return this.n_ = this.n_.concat(new Ye(e.Gc, Me.je())), this;
    }, t.prototype.commit = function() {
        return this.i_(), this.s_ = !0, this.n_.length > 0 ? this.t_.ql().write(this.n_) : Promise.resolve();
    }, t.prototype.i_ = function() {
        if (this.s_) throw new G$1(C$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), to = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.jc, t, r) || this).Gc = t, i.firestore = n, i.Kc = r, 
        i.Ml = i.firestore.ql(), i;
    }
    return __extends(n, e), n.Jl = function(t, e, r) {
        if (t.length % 2 != 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.N() + " has " + t.length);
        ...
        if (Wr("DocumentReference.collection", arguments, 1), Hr("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new G$1(C$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = B.$(t);
        ...
        var n = wo(this.Kc, t, e), r = Vi(this.firestore.jl, "DocumentReference.set", this.Gc, n, null !== this.Kc, e);
        return this.Ml.write(r.zc(this.Gc, Me.je()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof pi ? (Qr("DocumentReference.update", arguments, 2), 
        n = Si(this.firestore.jl, "DocumentReference.update", this.Gc, t, e, r)) : (Wr("DocumentReference.update", arguments, 1), 
        n = Li(this.firestore.jl, "DocumentReference.update", this.Gc, t)), this.Ml.write(n.zc(this.Gc, Me.exists(!0)));
    }, n.prototype.delete = function() {
        return Wr("DocumentReference.delete", arguments, 0), this.Ml.write([ new Ye(this.Gc, Me.je()) ]);
        ...
        } else Hr("DocumentReference.onSnapshot", "function", u, i[u]), $r("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
    ...
    function t(t, e, n, r, i, o) {
        this.t_ = t, this.Gc = e, this.o_ = n, this.h_ = r, this.a_ = i, this.Kc = o;
    }
    return t.prototype.data = function(t) {
        ...
        this.o_) {
            ...
            if (this.Kc) {
                var n = new ro(this.t_, this.Gc, this.o_, this.h_, this.a_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(n, t);
            }
            return new Hi(this.t_.jc, this.t_.Zl(), t.serverTimestamps || "none", (function(t) {
                return new to(t, e.t_, /* converter= */ null);
            })).bl(this.o_.Ze());
        }
        ...
        this.o_) {
            var r = this.o_.data().field(xi("DocumentSnapshot.get", t, this.Gc));
            if (null !== r) return new Hi(this.t_.jc, this.t_.Zl(), e.serverTimestamps || "none", (function(t) {
                return new to(t, n.t_, n.Kc);
            })).bl(r);
        }
        ...
        get: function() {
            return new to(this.Gc, this.t_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new eo(this.a_, this.h_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw oi("isEqual", "DocumentSnapshot", 1, e);
        return this.t_ === e.t_ && this.h_ === e.h_ && this.Gc.isEqual(e.Gc) && (null === this.o_ ? null === e.o_ : this.o_.isEqual(e.o_)) && this.Kc === e.Kc;
    }, t;
}(), ro = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
...
function io(t, e, n, r, i, o, s) {
    var u;
    if (i.O()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
    ...
    return function(t, e) {
        if (e.ln()) {
            var n = t.cn();
            if (null !== n && !n.isEqual(e.field)) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
            var r = t.un();
 ...
 */
        ...
        throw i === e.op ? new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
    }(t, l), l;
}

function oo(t, e, n) {
    if (null !== t.startAt) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new Ln(e, n);
    return function(t, e) {
        if (null === t.un()) {
...
function so(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!cn(e) && -1 !== n.indexOf("/")) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(B.$(n));
        if (!Q$1.W(r)) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Qt(t, new Q$1(r));
    }
    if (n instanceof _i) return Qt(t, n.Gc);
    throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ni(n) + ".");
}
 ...
 * array requirements.
 */ function uo(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if ("in" /* IN */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) {
        if (t.indexOf(null) >= 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
    }
}

function ao(t, e, n) {
    if (!n.isEqual(e)) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function co(t) {
    if (t.an() && 0 === t.tn.length) throw new G$1(C$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}

var ho = /** @class */ function() {
    function t(t, e, n) {
        this.u_ = t, this.firestore = e, this.Kc = n;
    }
    return t.prototype.where = function(e, n, r) {
        ...
        var o = xi("Query.where", e), s = io(this.u_, "Query.where", this.firestore.jl, this.firestore.jc, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new un(t.path, t.collectionGroup, t.tn.slice(), n, t.limit, t.en, t.startAt, t.endAt);
        }(this.u_, s), this.firestore, this.Kc);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (Kr("Query.orderBy", arguments, 1, 2), $r("Query.orderBy", "non-empty string", 2, n), 
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new G$1(C$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        var i = xi("Query.orderBy", e), o = oo(this.u_, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.tn.concat([ e ]);
            return new un(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.en, t.startAt, t.endAt);
        }(this.u_, o), this.firestore, this.Kc);
    }, t.prototype.limit = function(e) {
        return Wr("Query.limit", arguments, 1), Hr("Query.limit", "number", 1, e), si("Query.limit", 1, e), 
        new t(ln(this.u_, e, "F" /* First */), this.firestore, this.Kc);
    }, t.prototype.limitToLast = function(e) {
        return Wr("Query.limitToLast", arguments, 1), Hr("Query.limitToLast", "number", 1, e), 
        si("Query.limitToLast", 1, e), new t(ln(this.u_, e, "L" /* Last */), this.firestore, this.Kc);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Qr("Query.startAt", arguments, 1);
        var i = this.c_("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(pn(this.u_, i), this.firestore, this.Kc);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Qr("Query.startAfter", arguments, 1);
        var i = this.c_("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(pn(this.u_, i), this.firestore, this.Kc);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Qr("Query.endBefore", arguments, 1);
        var i = this.c_("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(dn(this.u_, i), this.firestore, this.Kc);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Qr("Query.endAt", arguments, 1);
        var i = this.c_("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(dn(this.u_, i), this.firestore, this.Kc);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw oi("isEqual", "Query", 1, e);
        return this.firestore === e.firestore && yn(this.u_, e.u_) && this.Kc === e.Kc;
    }, t.prototype.withConverter = function(e) {
        return new t(this.u_, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.c_ = function(t, e, n, i) {
        if (ri(t, 1, e), e instanceof no) return Wr(t, __spreadArrays([ e ], n), 1), function(t, e, n, r, i) {
            if (!r) throw new G$1(C$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = hn(t); s < u.length; s++) {
                ...
                if (a.field.O()) o.push(Qt(e, r.key)); else {
                    ...
                    if (St(c)) throw new G$1(C$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
                        throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
            return new Pn(o, i);
        }(this.u_, this.firestore.jc, t, e.o_, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            // Use explicit order by's because it has to match the query the user made
            var s = t.tn;
            if (i.length > s.length) throw new G$1(C$1.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.O()) {
                    if ("string" != typeof c) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!cn(t) && -1 !== c.indexOf("/")) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(B.$(c));
                    if (!Q$1.W(h)) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new Q$1(h);
                    u.push(Qt(e, f));
                } else {
                    var l = Ui(n, r, c);
            ...
            return new Pn(u, o);
        }(this.u_, this.firestore.jc, this.firestore.jl, t, o, i);
        ...
        } else Hr("Query.onSnapshot", "function", u, i[u]), $r("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        $r("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new fo(r.firestore, r.u_, t, r.Kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return co(this.u_), this.firestore.ql().listen(this.u_, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        Kr("Query.get", arguments, 0, 1), vo("Query.get", t), co(this.u_);
        var n = this.firestore.ql();
        return (t && "cache" === t.source ? n.Vl(this.u_) : n.yl(this.u_, t)).then((function(t) {
            return new fo(e.firestore, e.u_, t, e.Kc);
        }));
    }, t;
}(), fo = /** @class */ function() {
    function t(t, e, n, r) {
        this.t_ = t, this.l_ = e, this.__ = n, this.Kc = r, this.f_ = null, this.d_ = null, 
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return this.__.docs._();
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(t.prototype, "size", {
        get: function() {
            return this.__.docs.size;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.forEach = function(t, e) {
        var n = this;
        Kr("QuerySnapshot.forEach", arguments, 1, 2), Hr("QuerySnapshot.forEach", "function", 1, t), 
        this.__.docs.forEach((function(r) {
            t.call(e, n.w_(r, n.metadata.fromCache, n.__.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new ho(this.l_, this.t_, this.Kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (e && this.__.Ut) throw new G$1(C$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        return this.f_ && this.d_ === e || (this.f_ = 
        /**
     ...
     */
        ...
        }(this.__, e, this.w_.bind(this)), this.d_ = e), this.f_;
    }, 
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.t_ === e.t_ && yn(this.l_, e.l_) && this.__.isEqual(e.__) && this.Kc === e.Kc;
    }, t.prototype.w_ = function(t, e, n) {
        return new ro(this.t_, t.key, t, e, n, this.Kc);
    }, t;
}(), lo = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, an(t), n, r) || this).T_ = t, t.length % 2 != 1) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        get: function() {
            return this.u_.path.S();
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "parent", {
        get: function() {
            var t = this.u_.path.g();
            return t._() ? null : new to(new Q$1(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = P$1.t()), Hr("CollectionReference.doc", "non-empty string", 1, t);
        var e = B.$(t);
        return to.Jl(this.u_.path.child(e), this.firestore, this.Kc);
    }, n.prototype.add = function(t) {
        Wr("CollectionReference.add", arguments, 1), Hr("CollectionReference.add", "object", 1, this.Kc ? this.Kc.toFirestore(t) : t);
        var e = this.doc();
        return e.set(t).then((function() {
            return e;
        }));
    }, n.prototype.withConverter = function(t) {
        return new n(this.T_, this.firestore, t);
    }, n;
}(ho);
...
function po(t, e) {
    ...
    if (ii(t, e, [ "merge", "mergeFields" ]), Xr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + ni(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new G$1(C$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + ni(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof pi;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new G$1(C$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function vo(t, e) {
    $r(t, "object", 1, e), e && (ii(t, e, [ "source" ]), Jr(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}

function mo(t, e, n) {
    if (e instanceof _i) {
        if (e.firestore !== n) throw new G$1(C$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
 ...
 */ function Eo(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new Xi(t, e, new xr, new jr);
